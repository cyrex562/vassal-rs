...
public class PlaySound extends Decorator implements TranslatablePiece {
  ...
  public Command myKeyEvent(KeyStroke stroke) {
    ...
    if (command.matches(stroke)) {
      if (!GameModule.getGameModule().getGameState().isFastForwarding()) {
        final AuditTrail audit = AuditTrail.create(this, format, Resources::get_string("Editor.PlaySound.sound_clip"));
        ...
        try {
          ...
          reportDataError(this, Resources::get_string("Error.not_found", "Audio Clip"), "Clip=" + clipName,
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.PlaySound.trait_description");
  }
  ...
  public void mySetType(String type) {
    ...
    menuText = st.nextToken(Resources::get_string("Editor.PlaySound.default_command"));
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(menuText, Resources::get_string("Editor.PlaySound.play_sound_command"));
  }
