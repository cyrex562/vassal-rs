...
public class TableConfigurer extends Configurer implements ActionListener  {
  ...
  public static final String ADD_ACTION = Resources::get_string("Editor.TableConfigurer.add");
  public static final String DEL_ACTION = Resources::get_string("Editor.TableConfigurer.remove");
  public static final String INS_ACTION = Resources::get_string("Editor.TableConfigurer.insert");
  ...
  protected void updateContents() {
    ...
    for (final Column item : columns) {
      contents.add(new JLabel(item.get_name()));
    }
