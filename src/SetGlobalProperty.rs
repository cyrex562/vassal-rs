...
public class SetGlobalProperty extends DynamicProperty {
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.SetGlobalProperty.trait_description");
  }
  ...
  protected static class Ed implements PieceEditor {
    ...
    protected String mapText = Resources::get_string("Editor.SetGlobalProperty.name_of_map");
    private final String mapHint = Resources::get_string("Editor.GlobalKeyCommand.map_name_hint");
    protected String zoneText = Resources::get_string("Editor.SetGlobalProperty.name_of_zone");
    private final String zoneHint = Resources::get_string("Editor.GlobalKeyCommand.zone_name_hint");
    protected JLabel searchLabel;
    protected TraitConfigPanel controls;

    public Ed(final SetGlobalProperty m) {
      keyCommandListConfig = new DynamicKeyCommandListConfigurer(null, Resources::get_string("Editor.DynamicProperty.commands"), m);
      ...
      minLabel = new JLabel(Resources::get_string("Editor.GlobalProperty.minimum_value"));
      minConfig = new IntConfigurer(m.getMinimumValue());
      controls.add(minLabel, minConfig);

      maxLabel = new JLabel(Resources::get_string("Editor.GlobalProperty.maximum_value"));
