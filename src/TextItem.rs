...
public class TextItem extends Item {
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.insert(
      ...
      Resources::get_string("Editor.TextItem.font_style"),
      Resources::get_string("Editor.TextItem.text_option"),
      Resources::get_string("Editor.TextItem.text")
    );
  }
  ...
  public String getDisplayName() {
    return Resources::get_string("Editor.TextItem.component_type");
  }
