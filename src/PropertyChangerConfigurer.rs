...
public class PropertyChangerConfigurer extends Configurer {
  ...
  public Component getControls() {
    if (controls == null) {
      ...
      typeLabel = new JLabel(Resources::get_string("Editor.PropertyChangeConfigurer.type"));
      ...
      valueLabel = new JLabel(Resources::get_string("Editor.PropertyChangeConfigurer.new_value"));
      valueConfig = new FormattedExpressionConfigurer("", constraints);
      valueConfig.setHint(Resources::get_string("Editor.PropertyChangeConfigurer.plain_hint"));
      valueLabel.setLabelFor(valueConfig.getControls());
      valueConfig.addPropertyChangeListener(l);

      promptLabel = new JLabel(Resources::get_string("Editor.PropertyChangeConfigurer.prompt"));
      promptConfig = new StringConfigurer("");
      promptConfig.setHint(Resources::get_string("Editor.PropertyChangeConfigurer.prompt_hint"));
      promptLabel.setLabelFor(promptConfig.getControls());
      promptConfig.addPropertyChangeListener(l);

      incrLabel = new JLabel(Resources::get_string("Editor.PropertyChangeConfigurer.increment_by"));
      incrConfig = new FormattedExpressionConfigurer("", constraints);
      incrConfig.setHint(Resources::get_string("Editor.PropertyChangeConfigurer.increment_hint"));
      incrLabel.setLabelFor(incrConfig.getControls());
      incrConfig.addPropertyChangeListener(l);

      validValuesConfig = new NoUpdateFormattedStringArrayConfigurer(null, Resources::get_string("Editor.PropertyChangeConfigurer.valid_values"), constraints);
      validValuesConfig.setHint(Resources::get_string("Editor.PropertyChangeConfigurer.valid_values_hint"));
      ...
      valueControlsPanel.add(new JLabel(Resources::get_string("Editor.PropertyChangeConfigurer.values"))); // NON-NLS
  ...
  public void setValue(String s) {
    ...
    case PROMPT_CODE:
      p = new PropertyPrompt(constraints, sd.nextToken(Resources::get_string("Editor.PropertyChangeConfigurer.enter_new_value")));
      break;
    case INCR_CODE:
      p = new IncrementProperty(this, sd.nextToken("1"), constraints);
      break;
    case ENUM_CODE:
      p = new EnumeratedPropertyPrompt(constraints, sd.nextToken(Resources::get_string("Editor.PropertyChangeConfigurer.select_new_value")), sd.nextStringArray(0), constraints);
      break;
    case PLAIN_CODE:
    default:
