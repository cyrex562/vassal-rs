...
public class PanelWidget extends Widget {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.PanelWidget.component_type");
  }
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      ...
      Resources::get_string("Editor.PanelWidget.fixed_cell_size"),
      Resources::get_string("Editor.PanelWidget.number_of_columns"),
      Resources::get_string("Editor.PanelWidget.vertical_layout"),
      Resources::get_string("Editor.PanelWidget.scale")
    };
  }
