...
public class Zone extends AbstractConfigurable implements GridContainer, MutablePropertiesContainer, PropertySource, GameComponent {
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      ...
      Resources::get_string("Editor.Zone.location_format"),
      Resources::get_string("Editor.Zone.shape"),
      Resources::get_string("Editor.Zone.use_boards_grid"),
      Resources::get_string("Editor.Zone.use_highlighting"),
      Resources::get_string("Editor.Zone.highlight_property")
    };
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.Zone.component_type");
  }
  ...
  public List<String> getPropertyNames() {
    ...
    for (final ZoneProperty zp : get_components_of(ZoneProperty.class)) {
  ...
  public static class Editor extends Configurer implements PolygonConfigurer {
    ...
    protected Zone zone;
    protected final JLabel warning = new JLabel(Resources::get_string("Editor.Zone.zone_has_not_been_defined"));

    public Editor(final Zone zone) {
      super(PATH, null);

      buttonPanel = new JPanel(new MigLayout("ins 0")); // NON-NLS
      button = new JButton(Resources::get_string("Editor.Zone.define_shape"));
      buttonPanel.add(button);
      button.addActionListener(e -> init(zone));

      copyButton = new JButton(Resources::get_string("Editor.Zone.copy_coords"));
      buttonPanel.add(copyButton);
      copyButton.addActionListener(e -> copyCoords());

      pasteButton = new JButton(Resources::get_string("Editor.Zone.paste_coords"));
    ...
    private void copyCoords() {
      ...
      GameModule.getGameModule().warn(Resources::get_string("Editor.Zone.copied", (poly == null) ? 0 : poly.npoints, coords));
    }
    ...
    private void pasteCoords() {
      ...
      if (t != null) {
        try {
          ...
          GameModule.getGameModule().warn(Resources::get_string("Editor.Zone.pasted", (editor.getPolygon() == null) ? 0 : editor.getPolygon().npoints, pasteShape));
        }
    ...
    private void init(Zone zone, boolean show) {
      ...
      labels.add(new JLabel(Resources::get_string("Editor.Zone.drag_to_create_initial_shape")));
      labels.add(new JLabel(Resources::get_string("Editor.Zone.right_click_to_add_point")));
      labels.add(new JLabel(Resources::get_string("Editor.Zone.left_drag_to_move_points")));
      labels.add(new JLabel(Resources::get_string("Editor.Zone.del_to_remove_points")));
      labels.add(new JLabel(Resources::get_string("Editor.Zone.shift_drag_to_move_whole_shape")));
      labels.add(new JLabel(Resources::get_string("Editor.Zone.arrow_keys_adjust_position")));
      ...
      final JButton direct = new JButton(Resources::get_string("Editor.Zone.set_coordinates_directly"));
      direct.setFocusable(false);
      direct.addActionListener(e -> {
        String newShape = JOptionPane.showInputDialog(frame, Resources::get_string("Editor.Zone.enter_points_instructions"), PolygonEditor
      ...
      final JButton delete = new JButton(Resources::get_string("Editor.Zone.delete_all_points"));
      ...
      final JButton closeButton = new JButton(Resources::get_string("General.ok"));
      ...
      final JButton canButton = new JButton(Resources::get_string("General.cancel"));
