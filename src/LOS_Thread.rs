...
public class LOS_Thread extends AbstractToolbarItem implements
  ...
  protected FormattedString reportFormat = new FormattedString(Resources::get_string("Editor.LosThread.los_check_string"));
  ...
  public LOS_Thread() {
    ...
    setLaunchButton(makeLaunchButton(
      Resources::get_string("Editor.LosThread.show_los_thread"),
      Resources::get_string("Editor.LosThread.thread"),
      DEFAULT_ICON,
      e -> launch()
    ));
  ...
  public void addTo(Buildable b) {
    ...
    GameModule.getGameModule().getPrefs().addOption(getConfigureName(),
      new BooleanConfigurer(SNAP_LOS,
        Resources::get_string("LOS_Thread.snap_thread_preference")));

    if (fixedColor == null) {
      final ColorConfigurer config = new ColorConfigurer(LOS_COLOR,
        Resources::get_string("LOS_Thread.thread_color_preference"));
  ...
  public void drawRange(Graphics g, int range) {
    ...
    final String rangeMsg = Resources::get_string("LOS_Thread.range");
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.LosThread.component_type"); //$NON-NLS-1$
  }
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.addAll(
      ...
      Resources::get_string("Editor.LosThread.persistence"), //$NON-NLS-1$
      Resources::get_string("Editor.LosThread.icon_persist"), //$NON-NLS-1$
      Resources::get_string("Editor.LosThread.visible"), //$NON-NLS-1$
      Resources::get_string("Editor.LosThread.start_grid"), //$NON-NLS-1$
      Resources::get_string("Editor.LosThread.end_grid"), //$NON-NLS-1$
      Resources::get_string("Editor.LosThread.draw_range"), //$NON-NLS-1$
      Resources::get_string("Editor.LosThread.pixel_range"), //$NON-NLS-1$
      Resources::get_string("Editor.LosThread.round_fractions"), //$NON-NLS-1$
      Resources::get_string("Editor.LosThread.hidden"), //$NON-NLS-1$
      Resources::get_string("Editor.LosThread.opacity"), //$NON-NLS-1$
      Resources::get_string("Editor.LosThread.thickness"),
