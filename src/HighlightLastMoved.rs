...
public class HighlightLastMoved extends AbstractConfigurable implements Drawable, MouseListener, GameComponent {
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
        Resources::get_string("Editor.HighlightLastMoved.enabled"), //$NON-NLS-1$
        Resources::get_string(Resources.COLOR_LABEL),
        Resources::get_string("Editor.HighlightLastMoved.thickness"), //$NON-NLS-1$
    };
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.HighlightLastMoved.component_type"); //$NON-NLS-1$
  }
