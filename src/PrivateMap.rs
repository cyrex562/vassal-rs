...
public class PrivateMap extends Map {
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.addAll(
      new String[]{
        Resources::get_string("Editor.PrivateMap.belongs_to_one_side"),
        Resources::get_string("Editor.PrivateMap.visible_to_all_player"),
        Resources::get_string("Editor.PrivateMap.use_same_boards_as_this_map")
      },
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.PrivateMap.component_type"); //$NON-NLS-1$
  }
    ...
    validator = new ValidityChecker() {
      ...
      public void validate(Buildable target, ValidationReport report) {
        if (!PlayerRoster.isActive()) {
          report.addWarning(Resources::get_string("Editor.PrivateMap.warning",
