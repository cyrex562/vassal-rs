...
public class Chart extends Widget {
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{Resources::get_string("Editor.name_label"), Resources::get_string(Resources.DESCRIPTION), Resources::get_string("Editor.image_label")};
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.Chart.component_type");
  }
