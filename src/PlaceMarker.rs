...
public class PlaceMarker extends Decorator implements TranslatablePiece, RecursionLimiter.Loopable {
  ...
  public PlaceMarker() {
    this(ID + Resources::get_string("Editor.PlaceMarker.default_command") + ";M;null;null;null", null); // NON-NLS
  }
  ...
  public GamePiece createBaseMarker() {
    ...
    if (isMarkerStandalone()) {
      ...
      try {
        ...
        reportDataError(this, Resources::get_string("Error.place_error"),
  ...
  public String getDescription() {
    ...
    s += getCommandDesc(command.get_name(), key);
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.PlaceMarker.trait_description");
  }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(command.get_name(), getCommandDescription(description, Resources::get_string("Editor.PlaceMarker.place_marker_command")));
  }
  ...
  protected static class Ed implements PieceEditor {
    ...
    protected JButton defineButton = new JButton(Resources::get_string("Editor.PlaceMarker.define_marker"));
    protected JButton selectButton = new JButton(Resources::get_string("Editor.select"));
    ...
    protected Ed(PlaceMarker piece) {
      ...
      commandInput = new StringConfigurer(piece.command.get_name());
      ...
      final JLabel matchLabel = new JLabel(matchRotationConfig.get_name());
      ...
      if (aboveConfig != null) {
        ...
        aboveLabel = new JLabel(aboveConfig.get_name());
        aboveConfig.setName("");
    ...
    protected BooleanConfigurer createMatchRotationConfig() {
      return new BooleanConfigurer(null, Resources::get_string("Editor.PlaceMarker.match_rotation"));
    }
  ...
  public List<String> getMenuTextList() {
    return List.of(command.get_name());
  }
}
