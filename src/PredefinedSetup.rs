 ...
 /*  protected void  setRefresherOptions() {
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      ...
      Resources::get_string("Editor.PredefinedSetup.parent_menu"), //$NON-NLS-1$
      Resources::get_string("Editor.PredefinedSetup.predefined_file"), //$NON-NLS-1$
      Resources::get_string("Editor.PredefinedSetup.saved_game") //$NON-NLS-1$
    };
  }
  ...
  public void launch() {
    ...
    if (useFile && fileName != null) {
      try {
        ...
        ErrorDialog.dataWarning(new BadDataReport(this, Resources::get_string("Error.not_found", "Setup"), fileName, e)); //$NON-NLS-1$ //$NON-NLS-2$
      }
    }
    else {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.PredefinedSetup.component_type"); //$NON-NLS-1$
  }
