...
public class DiceButton extends AbstractToolbarItem {
  ...
  protected void initLaunchButton() {
    ...
    setLaunchButton(makeLaunchButton(
      Resources::get_string("Editor.DiceButton.dice_button_text"),
      Resources::get_string("Editor.DiceButton.dice_button_tooltip"),
      "/images/die.gif", //NON-NLS
      rollAction
    ));
    launch = getLaunchButton(); // for compatibility

    setAttribute(AbstractToolbarItem.NAME, Resources::get_string("Editor.DiceButton.dice_name")); //NON-NLS
  }

  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.DiceButton.component_type"); //$NON-NLS-1$
  }
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.addAll(
      ...
      Resources::get_string("Editor.DiceButton.prompt_value"), //$NON-NLS-1$
      Resources::get_string("Dice.number_of_dice"), //$NON-NLS-1$
      Resources::get_string("Editor.DiceButton.lock_number_of_dice"), //$NON-NLS-1$
      Resources::get_string("Dice.number_of_sides"), //$NON-NLS-1$
      Resources::get_string("Editor.DiceButton.lock_number_of_sides"), //$NON-NLS-1$
      Resources::get_string("Dice.add_to_each_side"), //$NON-NLS-1$
      Resources::get_string("Editor.DiceButton.lock_add_to_each_side"), //$NON-NLS-1$
      Resources::get_string("Dice.add_to_total"), //$NON-NLS-1$
      Resources::get_string("Editor.DiceButton.lock_add_to_total"), //$NON-NLS-1$
      Resources::get_string("Editor.DiceButton.report_total"), //$NON-NLS-1$
      Resources::get_string("Editor.DiceButton.sort_results"), //$NON-NLS-1$
      Resources::get_string("Editor.DiceButton.keep_dice"),
      Resources::get_string("Editor.DiceButton.keep_option"),
      Resources::get_string("Editor.DiceButton.keep_count")
    );
  }
