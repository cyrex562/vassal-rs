...
public class DrawPile extends SetupStack implements PropertySource, PropertyNameSource, ComponentDescription {
  ...
  public static class AssignedDeckPrompt extends TranslatableStringEnum {
    ...
    public static final String NONE_NAME = Resources::get_string("Editor.DrawPile.none");
    ...
    public String[] getValidValues(AutoConfigurable target) {
      ...
      for (final GameComponent g :
        ...
        if (g instanceof Map) {
          for (final DrawPile dp : ((Map) g).get_components_of(DrawPile.class)) {
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
        Resources::get_string(Resources.NAME_LABEL),
        Resources::get_string(Resources.DESCRIPTION),
        Resources::get_string("Editor.DrawPile.owning_board"), //$NON-NLS-1$
        Resources::get_string("Editor.x_position"), //$NON-NLS-1$
        Resources::get_string("Editor.y_position"), //$NON-NLS-1$
        Resources::get_string("Editor.width"), //$NON-NLS-1$
        Resources::get_string("Editor.height"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.multi_draw"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.draw_multiple_message"), //NON-NLS
        Resources::get_string("Editor.DrawPile.specific_draw"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.draw_specific_message"), //NON-NLS
        Resources::get_string("Editor.DrawPile.list_cards"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.sort_cards"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.facedown"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.face_flip_hotkey"),
        Resources::get_string("Editor.DrawPile.face_up_message"),
        Resources::get_string("Editor.DrawPile.face_up_hotkey"),
        Resources::get_string("Editor.DrawPile.face_up_report"),
        Resources::get_string("Editor.DrawPile.face_down_message"),
        Resources::get_string("Editor.DrawPile.face_down_hotkey"),
        Resources::get_string("Editor.DrawPile.facedown_report"),
        Resources::get_string("Editor.DrawPile.faceup"),
        Resources::get_string("Editor.DrawPile.reshuffle"), //$NON-NLS-1$        // Internally these match "SHUFFLE"
        Resources::get_string("Editor.DrawPile.reshuffle_text"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.reshuffle_report"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.reshuffle_key"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.reverse"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.reverse_text"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.reverse_report"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.reverse_key"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.outline"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.color"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.empty_key"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.empty_keyfrom"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.send_deck"), //$NON-NLS-1$        // Internally these match "RESHUFFLE"
        Resources::get_string("Editor.DrawPile.send_text"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.send_report"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.send_key"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.send_deck_name"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.saved"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.save_message"),
        Resources::get_string("Editor.DrawPile.save_key"),
        Resources::get_string("Editor.DrawPile.save_report"),
        Resources::get_string("Editor.DrawPile.load_message"),
        Resources::get_string("Editor.DrawPile.load_key"),
        Resources::get_string("Editor.DrawPile.load_report"),
        Resources::get_string("Editor.DrawPile.maxdisplay"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.perform_express"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.count_express"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.restrict_drag"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.match_express"), //$NON-NLS-1$
        Resources::get_string("Editor.DrawPile.deck_restrict_access"), //NON-NLS
        Resources::get_string("Editor.DrawPile.deck_owners"), //NON-NLS
    };
  }
  ...
  public String getAttributeValueString(String key) {
    if (WIDTH.equals(key)) {
      ...
      return NamedHotKeyConfigurer.encode(dummy.get_namedEmptyKey());
    }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.DrawPile.deck"); //$NON-NLS-1$
  }
  ...
  public List<String> getPropertyNames() {
    ...
    for (final String ce : dummy.getCountExpressions()) {
      l.add(getConfigureName() + "_" + (new Deck.CountExpression(ce)).get_name());
    }
