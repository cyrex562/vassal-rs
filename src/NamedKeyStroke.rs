...
public class NamedKeyStroke {
  ...
  public static NamedKeyStroke get_namedKeyStroke(char c) {
    return of(c);
  }
  @Deprecated(since = "2021-12-01", forRemoval = true)
  public static NamedKeyStroke get_namedKeyStroke(char c, int mod) {
    return of(c, mod);
  }

  @Deprecated(since = "2021-12-01", forRemoval = true)
  public static NamedKeyStroke get_namedKeyStroke(int c, int mod) {
    return of(c, mod);
  }
