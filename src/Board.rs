...
public class Board extends AbstractConfigurable implements GridContainer {
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
        ...
        Resources::get_string("Editor.Board.image"), //$NON-NLS-1$
        Resources::get_string("Editor.Board.reverse"), //$NON-NLS-1$
        Resources::get_string("Editor.Board.width"), //$NON-NLS-1$
        Resources::get_string("Editor.Board.height"), //$NON-NLS-1$
        Resources::get_string(Resources.COLOR_LABEL),
    };
  }

  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.Board.component_type"); //$NON-NLS-1$
  }
