...
public class ZonedGrid extends AbstractConfigurable implements GeometricGrid, GridContainer {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.MultiZoneGrid.component_type"); //$NON-NLS-1$
  }
  ...
  public void build(Element e) {
    super.build(e);
    if (get_components_of(ZonedGridHighlighter.class).isEmpty()) {
