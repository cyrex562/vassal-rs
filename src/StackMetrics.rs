...
public class StackMetrics extends AbstractConfigurable {
    ...
    if (EXSEP_X.equals(name)) {
      if (value instanceof String) {
        try {
          ...
          ErrorDialog.dataWarning(
              new BadDataReport(
                  Resources::get_string("Error.bad_preference", EXSEP_X, "StackMetrics"), (String) value, NaN)); //NON-NLS
        }
      }
      else if (value != null) {
      ...
      if (value instanceof String) {
        try {
          ...
          ErrorDialog.dataWarning(
              new BadDataReport(
                  Resources::get_string("Error.bad_preference", EXSEP_Y, "StackMetrics"), (String) value, NaN)); //NON-NLS
        }
      }
      else if (value != null) {
      ...
      if (value instanceof String) {
        try {
          ...
          ErrorDialog.dataWarning(
              new BadDataReport(
                  Resources::get_string("Error.bad_preference", UNEXSEP_X, "StackMetrics"), (String) value, NaN)); //NON-NLS
        }
      }
      else if (value != null) {
      ...
      if (value instanceof String) {
        try {
          ...
          ErrorDialog.dataWarning(
              new BadDataReport(
                  Resources::get_string("Error.bad_preference", UNEXSEP_Y, "StackMetrics"), (String) value, NaN)); //NON-NLS
        }
      }
      else if (value != null) {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.Stacking.component_type"); //$NON-NLS-1$
  }
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
        Resources::get_string("Editor.Stacking.disable"), //$NON-NLS-1$
        Resources::get_string("Editor.Stacking.h_expand"), //$NON-NLS-1$
        Resources::get_string("Editor.Stacking.v_expand"), //$NON-NLS-1$
        Resources::get_string("Editor.Stacking.hnon_expand"), //$NON-NLS-1$
        Resources::get_string("Editor.Stacking.vnon_expand"), //$NON-NLS-1$
        Resources::get_string("Editor.Stacking.color_nonexpand"), //$NON-NLS-1$
    };
  }
