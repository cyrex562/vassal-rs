...
public class LaunchButton extends JButton {
  ...
  public String getAttributeValueString(String key) {
    if (key.equals(nameAtt)) {
      ...
      return NamedHotKeyConfigurer.encode(keyListener.get_namedKeyStroke());
    }
  ...
  public void setToolTipText(String text) {
    ...
    if (keyListener.getKeyStroke() != null) {
      ...
      if (!keyListener.get_namedKeyStroke().isNamed()) {
  ...
  public Configurer get_nameConfigurer() {
    if (nameConfig == null && nameAtt != null) {
      nameConfig = new StringConfigurer(nameAtt, Resources::get_string("Editor.button_text_label"), getText()); //$NON-NLS-1$
    }
    return nameConfig;
  }
  ...
  public Configurer getHotkeyConfigurer() {
    if (keyConfig == null && keyAtt != null) {
      keyConfig = new NamedHotKeyConfigurer(keyAtt, Resources::get_string("Editor.hotkey_label"), keyListener.get_namedKeyStroke()); //$NON-NLS-1$
    }
    return keyConfig;
  }
