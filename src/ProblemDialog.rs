...
public class ProblemDialog {
  ...
  public static Future<?> show(
    ...
    return show(
      ...
      Resources::get_string(messageKey + "_title", args),   // NON-NLS
      Resources::get_string(messageKey + "_heading", args), // NON-NLS
      Resources::get_string(messageKey + "_message", args)  // NON-NLS
    );
  }
  ...
  public static Future<?> showDisableable(
    ...
    return DialogUtils.enqueue(() -> Dialogs.showMessageDialog(
      ...
      messageType,
      key,
      Resources::get_string("Dialogs.disable")
    ));
  }
  ...
  public static Future<?> showDisableableNoI18N(
    ...
    return DialogUtils.enqueue(() -> Dialogs.showMessageDialog(
      ...
      messageType,
      key,
      Resources::get_string("Dialogs.dont_show_again")
    ));
  }
  ...
  public static Future<?> showFileOverwriteFailure(
    ...
    return showDetails(
      messageType, parent, thrown, details,
      Resources::get_string(messageKey + "_title", thrown.getFile(), thrown.getOtherFile(), args), // NON-NLS
      Resources::get_string(messageKey + "_heading", thrown.getFile(), thrown.getOtherFile(), args), // NON-NLS
      Resources::get_string(messageKey + "_message", thrown.getFile(), thrown.getOtherFile(), args) // NON-NLS
    );
  }
  ...
  public static Future<?> showDetails(
    ...
    return DialogUtils.enqueue(() -> DetailsDialog.showDialog(
      ...
      details,
      Resources::get_string("Dialogs.disable"),
      Resources::get_string("Dialogs.show_details"),
      Resources::get_string("Dialogs.hide_details"),
      messageType,
      null
    ));
  }
  ...
  public static Future<?> showOutdatedUsage(String usage) {
    ...
    return showDisableable(JOptionPane.WARNING_MESSAGE,
      null, null, usage,
      Resources::get_string("Dialogs.out_of_date"),
      Resources::get_string("Dialogs.out_of_date"),
      Resources::get_string("Dialogs.out_dated_usage", usage) + "\n\n"
        + Resources::get_string("Dialogs.check_for_updated_module")
    );
  }
  ...
  public static Future<?> showOutdatedModule(String usage) {
    return showDisableable(JOptionPane.WARNING_MESSAGE,
      null, null, usage,
      Resources::get_string("Dialogs.module_version_incompatible"),
      Resources::get_string("Dialogs.module_version_incompatible"),
      Resources::get_string("Dialogs.module_version_incompatible_sequence", usage) + "\n\n"
        + Resources::get_string("Dialogs.check_for_updated_vmod")
    );
  }
}
