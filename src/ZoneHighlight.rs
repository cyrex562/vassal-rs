...
// FIXME: Make this an ImageOp?
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      ...
      Resources::get_string("Editor.ZoneHighlight.coverage"),
      Resources::get_string("Editor.ZoneHighlight.width"),
      Resources::get_string("Editor.ZoneHighlight.style"),
      Resources::get_string("Editor.ZoneHighlight.image"),
      Resources::get_string("Editor.ZoneHighlight.opacity")
    };
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.ZoneHighlight.component_type");
  }
  ...
  public class PercentageConfigurer extends Configurer {
    ...
    public Component getControls() {
      ...
      labelTable.put(0, new JLabel(Resources::get_string("Editor.ZoneHighlight.transparent")));
      labelTable.put(100, new JLabel(Resources::get_string("Editor.ZoneHighlight.opaque")));
