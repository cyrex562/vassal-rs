...
public class ToolbarMenu extends AbstractToolbarItem
  ...
  public ToolbarMenu() {
    ...
    setLaunchButton(makeLaunchButton(
      Resources::get_string("Editor.ToolbarMenu.tooltip_text"),
      Resources::get_string(Resources.MENU),
      "",
      e -> launch()
    ));
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.addAll(super.getAttributeDescriptions(),
                             Resources::get_string("Editor.ToolbarMenu.menu_entries")); //$NON-NLS-1$
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.ToolbarMenu.component_type"); //$NON-NLS-1$
  }
