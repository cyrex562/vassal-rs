...
public class LayerControl extends AbstractToolbarItem implements ComponentDescription {
  ...
  public LayerControl() {
    ...
    setLaunchButton(makeLaunchButton(
      Resources::get_string("Editor.LayerControl.reset_layers"),
      Resources::get_string("Editor.LayerControl.reset_layers"),
      "",
      e -> launch()
    ));
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.addAll(
      ...
      Resources::get_string("Editor.LayerControl.action"), //$NON-NLS-1$
      Resources::get_string("Editor.LayerControl.skip_layer"), //$NON-NLS-1$
      Resources::get_string("Editor.LayerControl.affect_layer") //$NON-NLS-1$
    );
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.LayerControl.component_type"); //$NON-NLS-1$
  }
}
