...
public class DebugControls extends AbstractBuildable implements ActionListener {
  ...
  public DebugControls() {
    ...
    leftPanel.setBorder(BorderFactory.createTitledBorder(
      ...
      Resources::get_string("Debug.component_type")));
  ...
  private void updateCoords() {
    cursorCoordsLabel.setText(Resources::get_string("Debug.cursor", cursorLocation.x, cursorLocation.y));
  }
  ...
  private void updateSelected() {
    ...
    selectedNameLabel.setText(piece.get_name());
  ...
  public void addTo(Buildable b) {
    ...
    launch = new JButton(Resources::get_string("Debug.debug_controls"));  //$NON-NLS-1$
    ...
    final IconConfigurer iconConfig = new IconConfigurer("debugControlsIcon", Resources::get_string("Debug.debug_controls_button_icon"), ""); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    final NamedHotKeyConfigurer keyConfig = new NamedHotKeyConfigurer("debugControlsHotKey", Resources::get_string("Debug.debug_controls_hotkey"), l.get_namedKeyStroke());   //$NON-NLS-1$ //$NON-NLS-2$
    ...
    keyConfig.addPropertyChangeListener(evt -> {
      ...
      launch.setToolTipText(Resources::get_string("Debug.debug_controls_tooltip", NamedHotKeyConfigurer.getString(l.getKeyStroke())));  //$NON-NLS-1$
    });
  ...
  public void toggleVisible() {
    if (controlPanel.getTopLevelAncestor() == null) {
      if (GlobalOptions.getInstance().isUseSingleWindow()) {
        ...
        final JFrame frame = new JFrame(Resources::get_string("Debug.debug_controls"));  //$NON-NLS-1$
