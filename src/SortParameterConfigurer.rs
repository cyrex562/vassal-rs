...
public class SortParameterConfigurer extends Configurer {
  ...
  public Component getControls() {
    if (controls == null) {
      ...
      final JLabel propertyLabel = new JLabel(Resources::get_string("Editor.DeckSortKeyCommand.name"));
      propertyLabel.setLabelFor(propertyConfig.getControls());
      controls.add(propertyLabel);
      controls.add(propertyConfig.getControls());

      final JLabel descendingLabel = new JLabel(Resources::get_string("Editor.DeckSortKeyCommand.descending"));
      ...
      final JLabel numericLabel = new JLabel(Resources::get_string("Editor.DeckSortKeyCommand.numeric"));
