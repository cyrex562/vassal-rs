...
public class Prefs implements Closeable {
  ...
  public void addOption(Configurer o) {
    addOption(Resources::get_string("Prefs.general_tab"), o); //$NON-NLS-1$
  }
  ...
  public static void initSharedGlobalPrefs() {
    ...
    final IntConfigurer overrideDefaultFontSize = new IntConfigurer(
        ...
        Resources::get_string("Prefs.override_default_font_size"),
       0
    );
    globalPrefs.addOption(Resources::get_string("Prefs.general_tab"), overrideDefaultFontSize);

    // Options to remember main window size
    final BooleanConfigurer windowRemember = new BooleanConfigurer(
      MAIN_WINDOW_REMEMBER,
      Resources::get_string("Prefs.main_window"),
      Boolean.TRUE
    );
    globalPrefs.addOption(Resources::get_string("Prefs.general_tab"), windowRemember);
    ...
    if (SystemUtils.IS_OS_WINDOWS) {
      ...
      final BooleanConfigurer d3dConf = new BooleanConfigurer(
        DISABLE_D3D,
        Resources::get_string("Prefs.disable_d3d"),
        Boolean.FALSE
      );
      globalPrefs.addOption(Resources::get_string("Prefs.compatibility_tab"), d3dConf);
    }
      ...
      final BooleanConfigurer oglfboConf = new BooleanConfigurer(
        DISABLE_OGL_FBO,
        Resources::get_string("Prefs.disable_ogl_fbo"),
        "aarch64".equals(System.getProperty("os.arch"))
      );
      globalPrefs.addOption(Resources::get_string("Prefs.compatibility_tab"), oglfboConf);
    }

    final BooleanConfigurer wizardConf = new BooleanConfigurer(
      WizardSupport.WELCOME_WIZARD_KEY,
      Resources::get_string("WizardSupport.ShowWizard"),
      Boolean.TRUE
    );
    ...
    final BooleanConfigurer auditConf = new BooleanConfigurer(
      ...
      Resources::get_string("Prefs.expression_auditing"),
      Boolean.FALSE
    );

    globalPrefs.addOption(Resources::get_string("Prefs.general_tab"), auditConf);
  }
