...
public class FontStyle extends AbstractConfigurable {
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
      Resources::get_string("Editor.FontStyle.style_name"),
      Resources::get_string("Editor.FontStyle.font_style")
    };
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.FontStyle.component_type");
  }
