...
public class Clone extends Decorator implements TranslatablePiece {
  ...
  public Clone() {
    this(ID + Resources::get_string("Editor.Clone.clone") + ";C", null); // NON-NLS
  }
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.Clone.trait_description");
  }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(commandName, Resources::get_string("Editor.Clone.clone_command_description"));
  }
