...
public class IncrementProperty implements PropertyChanger {
  ...
  public String getNewValue(String oldValue) {
    ...
    try {
      ...
      ErrorDialog.dataWarning(new BadDataReport(Resources::get_string("Error.non_number_error"), "Increment " + prop.get_name() + ": oldValue " + "=" + oldValue, e)); //NON-NLS
      return oldValue;
    }
    ...
    try {
      ...
      ErrorDialog.dataWarning(new BadDataReport(Resources::get_string("Error.non_number_error"),
        "Increment " + prop.get_name() + ": format=" + format.getFormat() + ", value=" + format.getText(constraints, constraints, audit), e, constraints, audit)); //NON-NLS
      return oldValue;
    }
  }
