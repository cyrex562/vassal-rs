...
public class MessageBoardControls {
  ...
  private void initComponents() {
    ...
    msgFrame = new JFrame(Resources::get_string("Chat.message_board"));  //$NON-NLS-1$
    ...
    final JButton refresh = new JButton(
      Resources::get_string("Chat.refresh"));  //$NON-NLS-1$
      ...
      new SwingWorker<Message[], Void>() {
        ...
        protected void done() {
          ...
          msgFrame.setTitle(serverName != null ?
            Resources::get_string("Chat.message_board_title", serverName) :
            Resources::get_string("Chat.message_board"));   //$NON-NLS-1$
    ...
    final JButton b = new JButton(Resources::get_string(Resources.CLOSE));
    ...
    checkMessagesAction = new AbstractAction(
                  Resources::get_string("Chat.check_messages")) {  //$NON-NLS-1$
    ...
    postMessageAction = new AbstractAction(
                      Resources::get_string("Chat.post_message")) {  //$NON-NLS-1$
      private static final long serialVersionUID = 1L;
  ...
  private class Comp extends JFrame {
    ...
    private Comp() {
      super(Resources::get_string("Chat.message_composer"));  //$NON-NLS-1$
      ...
      final JButton okButton =
        new JButton(Resources::get_string("Chat.send"));  //$NON-NLS-1$
