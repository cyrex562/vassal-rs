...
public class Pivot extends Decorator implements TranslatablePiece {
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.Pivot.trait_description");
  }
  ...
  public void mySetType(String type) {
    ...
    command = st.nextToken(Resources::get_string("Editor.Pivot.default_pivot_command"));
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(command, Resources::get_string("Editor.Pivot.pivot_command"));
  }
  ...
  public static class Ed implements PieceEditor {
    ...
    public Ed(Pivot p) {
      ...
      controls.add(new JLabel(Resources::get_string("Editor.Pivot.pivot_point")));
      ...
      angleLabel = new JLabel(Resources::get_string("Editor.Pivot.angle"));
