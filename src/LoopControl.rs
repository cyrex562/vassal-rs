...
public class LoopControl {
  ...
  public static final String[] LOOP_TYPE_DESCS = {
      Resources::get_string("Editor.LoopControl.repeat_fixed"), //$NON-NLS-1$
      Resources::get_string("Editor.LoopControl.repeat_until"), //$NON-NLS-1$
      Resources::get_string("Editor.LoopControl.repeat_while") }; //$NON-NLS-1$
