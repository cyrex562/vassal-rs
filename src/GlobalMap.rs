...
public class GlobalMap implements AutoConfigurable,
  ...
  public GlobalMap() {
    ...
    launch = new LaunchButton(null, TOOLTIP, BUTTON_TEXT,
                              HOTKEY, ICON_NAME, al);
    launch.setAttribute(TOOLTIP, Resources::get_string("Editor.GlobalMap.show_hide_overview_window"));
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
      ...
      Resources::get_string("Editor.GlobalMap.show_hide"), //$NON-NLS-1$
      Resources::get_string("Editor.GlobalMap.scale_factor"), //$NON-NLS-1$
      Resources::get_string("Editor.GlobalMap.hilight"), //$NON-NLS-1$
    };
  }
  ...
  public void setup(boolean show) {
    ...
    if (show && !map.get_components_of(CounterDetailViewer.class).isEmpty()) {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.GlobalMap.component_type"); //$NON-NLS-1$
  }
