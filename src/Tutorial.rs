...
public class Tutorial extends AbstractConfigurable {
  ...
  private String welcomeMessage = Resources::get_string("Tutorial.instructions"); //$NON-NLS-1$
  private String promptMessage = Resources::get_string("Tutorial.load_tutorial"); //$NON-NLS-1$
  protected BooleanConfigurer hasViewedTutorial;

  public Tutorial() {
    launch = new AbstractAction(Resources::get_string("Tutorial.tutorial")) { //$NON-NLS-1$
  ...
  public void launch() {
    GameModule.getGameModule().warn(Resources::get_string("Tutorial.loading_tutorial")); //$NON-NLS-1$
    ...
    new SwingWorker<Command, Void>() {
      ...
      protected void done() {
        ...
        // FIXME: review error message
          ...
          logger.error("", e);
          String msg = Resources::get_string("Tutorial.unable_to_launch", name); //$NON-NLS-1$
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
      ...
      Resources::get_string("Editor.Tutorial.logfile"),
      Resources::get_string("Editor.Tutorial.launch_automatically_on_first_startup"),
      Resources::get_string("Editor.Tutorial.auto_launch_confirm_message"),
      Resources::get_string("Editor.Tutorial.welcome_message")
    };
  }
