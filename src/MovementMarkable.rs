...
public class MovementMarkable extends Decorator implements TranslatablePiece {
  ...
  public void mySetType(String type) {
    ...
    command = st.nextToken(Resources::get_string("Editor.MovementMarkable.default_command"));
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.MovementMarkable.trait_description");
  }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(command, Resources::get_string("Editor.MovementMarkable.mark_moved_command"));
  }
  ...
  private static class Ed implements PieceEditor {
    ...
    public Component getControls() {
      ...
      if (!enabled) {
        final Runnable runnable = () -> JOptionPane.showMessageDialog(box, Resources::get_string("Editor.MovementMarkable.enable_text"), Resources::get_string("Editor.MovementMarkable.option_not_enabled"), JOptionPane.WARNING_MESSAGE);
