...
public class DeckSortKeyCommand extends AbstractDeckKeyCommand {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.DeckSortKeyCommand.component_type"); //$NON-NLS-1$
  }
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.addAll(super.getAttributeDescriptions(), Resources::get_string("Editor.DeckSortKeyCommand.sort_by"));
  }
