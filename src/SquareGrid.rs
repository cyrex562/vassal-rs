...
public class SquareGrid extends AbstractConfigurable implements GeometricGrid, GridEditor.EditableGrid {
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      Resources::get_string("Editor.x_offset"), //$NON-NLS-1$
      Resources::get_string("Editor.y_offset"), //$NON-NLS-1$
      Resources::get_string("Editor.RectangleGrid.width"), //$NON-NLS-1$
      Resources::get_string("Editor.RectangleGrid.height"), //$NON-NLS-1$
      Resources::get_string("Editor.RectangleGrid.range_method"), //$NON-NLS-1$
      Resources::get_string("Editor.Grid.snap"), //$NON-NLS-1$
      Resources::get_string("Editor.Grid.edges"), //$NON-NLS-1$
      Resources::get_string("Editor.RectangleGrid.corners"), //$NON-NLS-1$
      Resources::get_string("Editor.Grid.show_grid"), //$NON-NLS-1$
      Resources::get_string("Editor.Grid.center_dots"), //$NON-NLS-1$
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.RectangleGrid.component_type"); //$NON-NLS-1$
  }
...
//        int yRange = range - abs(x); /* This creates a diamond-shaped range.  Configuration option?  */
  ...
  public Configurer getConfigurer() {
    ...
    if (!buttonExists) {
      final JButton b = new JButton(Resources::get_string("Editor.Grid.edit_grid")); //$NON-NLS-1$
