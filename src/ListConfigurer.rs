...
public abstract class ListConfigurer extends Configurer implements PropertyChangeListener {
  ...
  public Component getControls() {
    if (panel == null) {
      ...
      final JButton addButton = new JButton(Resources::get_string("Editor.ListConfigurer.new"));
  ...
  protected void updateControls() {
    if (controls != null) {
      ...
      for (final Object value : getListValue()) {
        ...
        final JButton delButton = new JButton(Resources::get_string("Editor.ListConfigurer.remove"));
