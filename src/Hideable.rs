...
public class Hideable extends Decorator implements TranslatablePiece {
  ...
  protected String command = Resources::get_string("Editor.Hideable.default_command");
  ...
  public void mySetType(String type) {
    ...
    command = st.nextToken(Resources::get_string("Editor.Hideable.default_command"));
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.Hideable.trait_description");
  }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(command, Resources::get_string("Editor.Hideable.hide_command"));
  }
