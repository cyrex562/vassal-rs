...
public class SoundConfigurer extends Configurer {
  ...
  public Component getControls() {
    if (controls == null) {
      controls = new ConfigurerPanel(get_name(), "[]rel[]rel[]rel[grow,fill]", "[]rel[]rel[]rel[]rel[grow,fill]"); // NON-NLS

      JButton b = new JButton(Resources::get_string("Editor.SoundConfigurer.play"));
      b.addActionListener(e -> play());
      controls.add(b);
      b = new JButton(Resources::get_string("Editor.SoundConfigurer.default"));
      b.addActionListener(e -> setValue(DEFAULT));
      controls.add(b);
      b = new JButton(Resources::get_string("Editor.SoundConfigurer.select"));
