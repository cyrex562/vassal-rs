...
public class UsePrototype extends Decorator implements EditablePiece, Loopable {
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.UsePrototype.trait_description");
  }
  ...
  public String get_name() {
    return getExpandedInner().get_name();
  }
  ...
  public static class Editor implements PieceEditor {
    ...
    public Editor(UsePrototype up) {
      ...
      final JButton selectButton = new JButton(Resources::get_string(Resources.SELECT));
