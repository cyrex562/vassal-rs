...
public class GlobalCommandTargetConfigurer extends Configurer {
  ...
  public Component getControls() {
    if (controls == null) {
      ...
      controls.add(new JLabel(Resources::get_string("Editor.GlobalKeyCommand.by_location")), "wrap"); //NON-NLS
      ...
      targetTypeLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.select_by"));
      ...
      targetMapLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.map_name"));
      ...
      targetBoardLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.board_name"));
      ...
      targetZoneLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.zone_name"));
      ...
      targetLocationLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.location_name"));
      ...
      targetXLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.x_position"));
      ...
      targetYLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.y_position"));
      ...
      targetDeckLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.deck_name"));
      ...
      controls.add(new JLabel(Resources::get_string("Editor.GlobalKeyCommand.by_property")), "wrap"); //NON-NLS
      ...
      targetPropertyLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.property_name"));
      ...
      targetCompareLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.property_compare"));
      ...
      targetValueLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.property_value"));
