...
public class CounterGlobalKeyCommand extends Decorator
  ...
  public void mySetType(String type) {
    ...
    commandName = st.nextToken(Resources::get_string("Editor.GlobalkeyCommand.command"));
  ...
  public String getDescription() {
    String d = Resources::get_string("Editor.GlobalkeyCommand.global_key_command");
  ...
  public Command apply() {
    ...
    final AuditTrail audit = AuditTrail.create(this, propertiesFilter.getExpression(), Resources::get_string("Editor.GlobalKeyCommand.matching_properties"));
    ...
    if (restrictRange) {
      ...
      if (!fixedRange) {
        ...
        try {
          ...
          reportDataError(this, Resources::get_string("Error.non_number_error"), "range[" + rangeProperty + "]=" + rangeValue, e); // NON-NLS
        }
      }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(commandName, getCommandDescription(description, Resources::get_string("Editor.menu_command")));
  }
  ...
  public static class Ed implements PieceEditor {
    ...
    public Ed(CounterGlobalKeyCommand p) {
      ...
      fixedRangeLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.fixed_range"));
      traitPanel.add(fixedRangeLabel, fixedRange);
      fixedRange.addPropertyChangeListener(pl);

      range = new IntConfigurer(p.range);
      rangeLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.range"));
      ...
      rangePropertyLabel = new JLabel(Resources::get_string("Editor.GlobalKeyCommand.range_property"));
