...
public class ActionButton extends Decorator implements EditablePiece, Loopable {
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.ActionButton.trait_description");
  }
  ...
  public static class VisualEditor implements PolygonConfigurer {
    ...
    protected final JLabel warning = new JLabel(Resources::get_string("Editor.ActionButton.empty_polygon"));
    ...
    public void show(ActionButton piece, Polygon poly, Ed pieceEditor) {
      ...
      frame = new JDialog(GameModule.getGameModule().getPlayerWindow(), Resources::get_string("Editor.ActionButton.define_hotspot"), true);
      ...
      final JButton direct = new JButton(Resources::get_string("Editor.ActionButton.set_coordinates_directly"));
      direct.setFocusable(false);
      direct.addActionListener(e -> {
        String newShape = JOptionPane.showInputDialog(frame, Resources::get_string("Editor.ActionButton.enter_points_instructions"), PolygonEditor
      ...
      frame.setTitle(Resources::get_string("Editor.ActionButton.define_hotspot"));
  ...
  public static class Ed implements PieceEditor {
    ...
    public Ed(ActionButton p) {
      ...
      defineButton = new JButton(Resources::get_string("Editor.ActionButton.define_shape"));
