...
public class ModuleEditorWindow extends EditorWindow {
  ...
  public ModuleEditorWindow(GameModule mod) {
    ...
    updateSavedGame = new AbstractAction(Resources::get_string(
  ...
  public String getEditorType() {
    return Resources::get_string("Editor.ModuleEditor.component_type");
  }

  @Override
  public void updateWindowTitle() {
    String title = Resources::get_string("Editor.ModuleEditor.editor_name", Info.get_version());
