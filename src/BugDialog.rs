...
public class BugDialog extends JDialog {
  ...
  public BugDialog(Frame owner, Throwable thrown) {
    ...
    final JXHeader header = new JXHeader(
      Resources::get_string("BugDialog.heading"),
      Resources::get_string("BugDialog.message"),
    ...
    // dialog
    //
    setTitle(Resources::get_string("BugDialog.title"));
  ...
  private Component buildVersionCheckPanel() {
    ...
    final FlowLabel label =
      new FlowLabel(Resources::get_string("BugDialog.collecting_details"));
  ...
  private Component buildVersionCheckButtons() {
    final JButton cancelButton = new JButton(
      new AbstractAction(Resources::get_string(Resources.CANCEL)) {
        private static final long serialVersionUID = 1L;
...
// FIXME: tags don't push buttons to ends?
  ...
  private Component buildCurrentVersionPanel() {
    final FlowLabel label = new FlowLabel(
      Resources::get_string("BugDialog.current_version_instructions"));
    ...
    final JLabel descriptionLabel =
      new JLabel(Resources::get_string("BugDialog.bug_description"));
    ...
    final JLabel emailLabel = new JLabel(
      Resources::get_string("BugDialog.user_email_address"));
  ...
  private Component buildCurrentVersionButtons() {
    final JButton sendButton = new JButton(
      new AbstractAction(Resources::get_string("BugDialog.send_button")) {
        private static final long serialVersionUID = 1L;
    ...
    final JButton dontSendButton = new JButton(
      new AbstractAction(Resources::get_string("BugDialog.dont_send_button")) {
        private static final long serialVersionUID = 1L;
  ...
  private Component buildNonReportingVersionPanel(String key) {
    final FlowLabel label = new FlowLabel(Resources::get_string(key));
  ...
  private Component buildNonReportingVersionButtons() {
    final JButton okButton = new JButton(
      new AbstractAction(Resources::get_string(Resources.OK)) {
        private static final long serialVersionUID = 1L;
  ...
  private Component buildEmergencySavePanel() {
    final FlowLabel label =
      new FlowLabel(Resources::get_string("BugDialog.how_to_proceed"));
...
*/
  ...
  private class CheckRequest extends SwingWorker<Integer, Void> {
    ...
    protected Integer doInBackground() throws Exception {
      ...
      final int cur = compareReportable(Info.get_version());
      latch.await();
      return cur;
    }
  ...
  private Component buildSendingBugReportPanel() {
    ...
    final FlowLabel label =
      new FlowLabel(Resources::get_string("BugDialog.sending_bug_report"));
