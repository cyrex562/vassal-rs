...
public class GlobalProperty extends AbstractConfigurable implements ToolBarComponent, GameComponent, CommandEncoder, PropertySource, MutableProperty {
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      ...
      Resources::get_string("Editor.GlobalProperty.initial_value"),
      Resources::get_string("Editor.description_label"),
      Resources::get_string("Editor.GlobalProperty.is_numeric"),
      Resources::get_string("Editor.GlobalProperty.minimum_value"),
      Resources::get_string("Editor.GlobalProperty.maximum_value"),
      Resources::get_string("Editor.GlobalProperty.wrap_around")
    };
  }
  ...
  public String encode(Command c) {
    ...
    if (!sgp.getTarget_name().equals(getPropertyId())) {
      return null;
    }
  ...
  public static class SetGlobalProperty extends Command {
    ...
    public String getTarget_name() {
      if (target == null) {
        ...
        final String target_name = target.getPropertyId();
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.GlobalProperty.component_type");
  }
  ...
  public List<String> getPropertyList() {
    return List.of(property.get_name());
  }
