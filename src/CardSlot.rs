...
public class CardSlot extends PieceSlot {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.CardSlot.component_type");
  }
  ...
  public Configurer getConfigurer() {
    if (getPiece() == null) {
      ...
      theCard = GameModule.getGameModule().createPiece(Obscurable.ID + "F;;" + Resources::get_string("Editor.CardSlot.default_hide_command") + ";B", theCard); //NON-NLS
      setPiece(theCard);
    }
