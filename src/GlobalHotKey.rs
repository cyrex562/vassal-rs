...
public class GlobalHotKey extends Decorator implements TranslatablePiece {
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.GlobalHotKey.trait_description");
  }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(commandName, Resources::get_string("Editor.GlobalHoyKey.global_hotkey_command")); // NON-NLS
  }
