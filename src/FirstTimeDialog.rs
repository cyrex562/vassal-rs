...
public class FirstTimeDialog extends JDialog {
  ...
  public FirstTimeDialog(Frame parent) {
    ...
    welcome.setText(Resources::get_string("Main.welcome"));  //$NON-NLS-1$
    welcome.setForeground(Color.black);

    final JButton tour = new JButton(new LaunchTourAction(parent));
    final JButton jump =
      new JButton(Resources::get_string("Main.jump_right_in"));  //$NON-NLS-1$
    ...
    final JLabel lang = new JLabel(Resources::get_string("Prefs.language") + ":");
    ...
    langbox.addActionListener(e -> {
      ...
      welcome.setText(Resources::get_string("Main.welcome"));  //$NON-NLS-1$
      tour.setText(Resources::get_string("Main.tour"));  //$NON-NLS-1$
      jump.setText(Resources::get_string("Main.jump_right_in"));  //$NON-NLS-1$
      help.setText(Resources::get_string(Resources.HELP));
      lang.setText(Resources::get_string("Prefs.language") + ":");
      pack();
