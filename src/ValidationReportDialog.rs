...
public class ValidationReportDialog extends JDialog {
  ...
  public ValidationReportDialog(ValidationReport report, CallBack cb) {
    ...
    setTitle(Resources::get_string("Editor.ValidationReportDialog.problems"));
    ...
    case 0:
      add(new JLabel(Resources::get_string("Editor.ValidationReportDialog.no_problems")), "wrap");
      okButton = createOkButton();
      buttonPanel.add(okButton);
      cancelButton = okButton;
      break;
    default:
      add(new JLabel(Resources::get_string("Editor.ValidationReportDialog.following_problems")), "wrap");
      add(new JLabel(Resources::get_string("Editor.ValidationReportDialog.danger_will_robinson")), "wrap");
  ...
  private JButton createOkButton() {
    final JButton ok = new JButton(Resources::get_string("Editor.ValidationReportDialog.ignore"));
