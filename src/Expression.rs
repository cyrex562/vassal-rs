...
public class Expression {
  ...
  protected void handleError(ExpressionException e) {
    ErrorDialog.dataWarning(new BadDataReport(Resources::get_string("Error.expression_error"), getExpression(), e));
  }
  ...
  public String tryEvaluate(PropertySource ps, Auditable owner, String fieldKey) {
    return tryEvaluate(ps, null, false, owner, AuditTrail.create(owner, getExpression(), Resources::get_string(fieldKey)));
  }
