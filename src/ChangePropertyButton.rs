...
public class ChangePropertyButton extends AbstractToolbarItem implements PropertyChangerConfigurer.Constraints {
  ...
  public ChangePropertyButton() {
    ...
    setLaunchButton(makeLaunchButton(
      Resources::get_string("Editor.ChangePropertyButton.change"),
      Resources::get_string("Editor.ChangePropertyButton.change"),
      "",
      e -> launch()
    ));
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.addAll(
      ...
      Resources::get_string("Editor.ChangePropertyButton.options")
    );
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.ChangePropertyButton.component_type");
  }
