...
public class TurnGlobalHotkey extends AbstractConfigurable {
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
      ...
      Resources::get_string("Editor.TurnGlobalHotkey.global_hotkey"),
      Resources::get_string("Editor.TurnGlobalHotkey.match_properties"),
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.TurnGlobalHotkey.component_type");
  }
