...
public class WriteErrorDialog {
  ...
  public static void showError(
    ...
    ProblemDialog.showDetails(
      ...
      e,
      ThrowableUtils.getStackTrace(e),
      Resources::get_string(messageKey + "_title"), // NON-NLS
      Resources::get_string(messageKey + "_heading"), // NON-NLS
      Resources::get_string(messageKey + "_message", file.get_name(), msg) // NON-NLS
    );
  }
}
