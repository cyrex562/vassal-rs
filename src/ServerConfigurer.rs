...
public class ServerConfigurer extends Configurer {
  private static final String CONNECTED = Resources::get_string("Server.please_disconnect"); //$NON-NLS-1$
  private static final String DISCONNECTED = Resources::get_string("Server.select_server_type"); //$NON-NLS-1$
  private static final String P2P_BUTTON = Resources::get_string("Server.direct"); //$NON-NLS-1$
  private static final String OFFICIAL_BUTTON = Resources::get_string("Server.official"); //$NON-NLS-1$
