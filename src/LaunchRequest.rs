...
public class LaunchRequest implements Serializable {
  ...
  private static String helpMeSpock() {
    ...
    */
    return Resources::get_string("LaunchRequest.usage") + ":\n" +
      "  VASSAL -c\n" + //NON-NLS
      ...
      "\n" +
      Resources::get_string("LaunchRequest.options") + ":\n" +
      "  -a, --auto          TODO\n" + //NON-NLS
      "  -c, --chatlog       " + Resources::get_string("LaunchRequest.chatlog") + "\n" + //NON-NLS
      "  -e, --edit          " + Resources::get_string("LaunchRequest.edit") + "\n" + //NON-NLS
      "  -h, --help          " + Resources::get_string("LaunchRequest.help") + "\n" + //NON-NLS
      "  -i, --import        " + Resources::get_string("LaunchRequest.import") + "\n" + //NON-NLS
      "  -l, --load          " + Resources::get_string("LaunchRequest.load") + "\n" + //NON-NLS
      "  -m, --manage        " + Resources::get_string("LaunchRequest.manage") + "\n" + //NON-NLS
      "  -n, --new           " + Resources::get_string("LaunchRequest.new") + "\n" + //NON-NLS
      "  --auto-extensions   TODO\n" + //NON-NLS
      "  --edit-extension    " + Resources::get_string("LaunchRequest.extension") + "\n" + //NON-NLS
      "  --new-extension     " + Resources::get_string("LaunchRequest.new_extension") + "\n" + //NON-NLS
      "  --version           " + Resources::get_string("LaunchRequest.version") + "\n" + //NON-NLS
      "  --                  " + Resources::get_string("LaunchRequest.terminate") + "\n" + //NON-NLS
      "\n" +
      Resources::get_string("LaunchRequest.default") + "\n" +
      "\n";
  }
  ...
  public static LaunchRequest parseArgs(String[] args)
    ...
    while ((c = g.getopt()) != -1) {
      ...
      case PORT:
        ...
        break;
      case VERSION:
        System.err.println("VASSAL " + Info.get_version()); //NON-NLS
        System.exit(0);
        break;
      case TRANSLATE:
