...
public class Delete extends Decorator implements TranslatablePiece {
  ...
  public Delete() {
    this(ID + Resources::get_string("Editor.Delete.delete") + ";D", null); // NON-NLS
  }
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.Delete.trait_description");
  }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(commandName, Resources::get_string("Editor.Delete.delete_command_description"));
  }
