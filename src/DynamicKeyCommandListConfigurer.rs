...
public class DynamicKeyCommandListConfigurer extends Configurer implements ConfigurableList {
  ...
  private void buildHeader() {
    ...
    final JLabel commandHeader = new JLabel(Resources::get_string("Editor.menu_command"));
    ...
    final JLabel keyHeader  = new JLabel(Resources::get_string("Editor.keyboard_command"));
    keyHeader.setFont(boldFont);
    configControls.add(keyHeader, "growx 0,alignx center"); // NON-NLS

    final JLabel typeLabel = new JLabel(Resources::get_string("Editor.PropertyChangeConfigurer.type"));
    typeLabel.setFont(boldFont);
    configControls.add(typeLabel, "growx 0,alignx center"); // NON-NLS

    final JLabel promptLabel = new JLabel(Resources::get_string("Editor.PropertyChangeConfigurer.prompt"));
