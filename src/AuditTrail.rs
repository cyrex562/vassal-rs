...
public class AuditTrail {
  ...
  public AuditTrail(Auditable source, String originalExpression, String sourceField) {
    ...
    if (sourceField != null && ! sourceField.isEmpty()) {
      addMessage(Resources::get_string("Audit.source_field", sourceField));
    }
  ...
  public void setExpression(String expression) {
    if (expression != null && ! expression.isEmpty()) {
      addMessage(Resources::get_string("Audit.expression", expression));
    }
  }
  ...
  public String toString() {
    ...
    if (source != null) {
      ...
      if (source instanceof EditablePiece) {
        sb.append("\n   ")
          .append(Resources::get_string("Audit.source_type", "Piece Trait"))
          .append("\n   ")
          .append(Resources::get_string("Audit.source_name", source.getComponentName()))
          .append("\n   ")
          .append(Resources::get_string("Audit.source_description", source.getComponentTypeName()));
      }
      if (source instanceof AbstractConfigurable) {
        sb.append("\n   ")
          .append(Resources::get_string("Audit.source_type", source.getComponentTypeName()))
          .append("\n   ")
          .append(Resources::get_string("Audit.source_name", source.getComponentName()));
      }
