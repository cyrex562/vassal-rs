...
public class Replace extends PlaceMarker {
  ...
  public Replace() {
    this(ID + Resources::get_string("Editor.Replace.default_command") + ";R;null", null); // NON-NLS
  }
  ...
  protected Command replacePiece() {
    ...
    c = placeMarker();
    if (c == null) {
      reportDataError(this, Resources::get_string("Error.bad_replace"));
    }
    else {
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.Replace.trait_description");
  }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(command.get_name(), getCommandDescription(description, Resources::get_string("Editor.Replace.replace_command")));
  }
  ...
  protected static class Ed extends PlaceMarker.Ed {
    ...
    public Ed(Replace piece) {
      super(piece);
      defineButton.setText(Resources::get_string("Editor.Replace.define_replacement"));
    }

    @Override
    protected BooleanConfigurer createMatchRotationConfig() {
      return new BooleanConfigurer(null, Resources::get_string("Editor.Replace.match_current_state"));
    }

    @Override
    protected BooleanConfigurer createAboveConfig() {
      return new BooleanConfigurer(null, Resources::get_string("Editor.Replace.only_match_above"));
    }
