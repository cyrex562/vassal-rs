...
public class NamedHotKeyConfigurer extends Configurer implements FocusListener {
  private static final String STROKE_HINT = Resources::get_string("Editor.NamedHotKeyConfigurer.keystroke");
  private static final String NAME_HINT = Resources::get_string("Editor.NamedHotKeyConfigurer.command");
  ...
  public void setValue(Object o) {
    ...
    if (controls != null && !noUpdate) {
      ...
      if (stroke != null && stroke.isNamed()) {
        keyName.setText(stroke.get_name());
        keyStroke.setText("");
      }
      else {
        keyName.setText("");
  ...
  public Component getControls() {
    if (controls == null) {
      controls = new ConfigurerPanel(get_name(), "[fill,grow]", "[][fill,grow]"); // NON-NLS
      ...
      keyName.setText(getValueNamedKeyStroke() == null ? null : getValueNamedKeyStroke().get_name());
      ...
      undoButton.setToolTipText(Resources::get_string("Editor.undo"));
