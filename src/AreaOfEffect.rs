...
public class AreaOfEffect extends Decorator implements TranslatablePiece, MapShader.ShadedPiece {
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.AreaOfEffect.trait_description");
  }
  ...
  public void mySetType(String type) {
    ...
    activateCommand = st.nextToken(Resources::get_string("Editor.AreaOfEffect.show_area"));
  ...
  protected static class TraitEditor implements PieceEditor {
    ...
    protected TraitEditor(AreaOfEffect trait) {
      ...
      final JButton b = new JButton(Resources::get_string("Editor.AreaOfEffect.select"));
      selectShader.add(b);
      ...
      selectShaderLabel = new JLabel(Resources::get_string("Editor.AreaOfEffect.map_shading"));
      panel.add(selectShaderLabel, selectShader);

      transparencyColorLabel = new JLabel(Resources::get_string("Editor.AreaOfEffect.fill_color"));
      ...
      transparencyLabel = new JLabel(Resources::get_string("Editor.AreaOfEffect.opacity"));
      ...
      radiusValueLabel = new JLabel(Resources::get_string("Editor.AreaOfEffect.radius"));
      radiusValue = new IntConfigurer(trait.radius);
      panel.add(radiusValueLabel, radiusValue);

      radiusMarkerLabel = new JLabel(Resources::get_string("Editor.AreaOfEffect.radius_marker"));
      ...
      activateCommandLabel = new JLabel(Resources::get_string("Editor.AreaOfEffect.toggle_visible_command"));
      activateKey = new NamedHotKeyConfigurer(trait.activateKey);
      activateKeyLabel = new JLabel(Resources::get_string("Editor.AreaOfEffect.toggle_visible_keyboard_shortcut"));
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(activateCommand, getCommandDescription(description, Resources::get_string("Editor.AreaOfEffect.toggle_visible_command_name")));
  }
}
