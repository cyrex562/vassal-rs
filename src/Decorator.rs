...
public abstract class Decorator extends AbstractImageFinder implements EditablePiece, StateMergeable, PropertyNameSource, PersistentPropertyContainer,
  ...
  public String toString() {
    if (piece == null) {
      ...
      return super.toString() + "[name=" + get_name() + ",type=" + getType() + ",state=" + getState() + "]"; //$NON-NLS-1$//
    }
  }
  ...
  protected String buildDescription(String i18nKey) {
    return Resources::get_string(i18nKey);
  }
  ...
  public String getComponentTypeName() {
    return Resources::get_string("Audit.trait", getDescription());
  }
  ...
  public String getComponentName() {
    return Resources::get_string("Audit.piece", piece.get_name());
  }
