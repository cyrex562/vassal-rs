...
public class SavedGameUpdaterDialog extends JDialog {
  ...
  public SavedGameUpdaterDialog(Frame owner) throws HeadlessException {
    super(owner, false);
    setTitle(Resources::get_string("Editor.SavedGameUpdaterDialog.title"));
    initComponents();
    fc = new JFileChooser();
  ...
  private void initComponents() {
    ...
    versionBox.add(new JLabel(Resources::get_string("Editor.SavedGameUpdaterDialog.module_version")));
    ...
    final JButton importButton = new JButton(Resources::get_string("Editor.SavedGameUpdaterDialog.import_gamepiece"));
    importButton.addActionListener(e -> importPieceInfo());
    versionBox.add(importButton);
    add(versionBox);
    final JButton exportButton = new JButton(Resources::get_string("Editor.SavedGameUpdaterDialog.export_gamepiece"));
    ...
    left.add(new JLabel(Resources::get_string("Editor.SavedGameUpdaterDialog.saved_games")));
    final JButton chooseGamesButton = new JButton(Resources::get_string("Editor.SavedGameUpdaterDialog.choose"));
    ...
    updateButton = new JButton(Resources::get_string("Editor.SavedGameUpdaterDialog.update_games"));
    updateButton.addActionListener(e -> updateGames());
    updateButton.setEnabled(false);
    buttonsBox.add(updateButton);
    final JButton helpButton = new JButton(Resources::get_string("Editor.SavedGameUpdaterDialog.help"));
    ...
    final JButton closeButton = new JButton(Resources::get_string("Editor.SavedGameUpdaterDialog.close"));
    ...
    final Runnable runnable = () -> {
      ...
      for (int i = 0; i < n; ++i) {
        try {
          ...
          GameModule.getGameModule().warn(Resources::get_string("Editor.SavedGameUpdaterDialog.updated_message", savedGame.get_name(), versionField.getText(), GameModule.getGameModule().get_game_version()));
        }
        // FIXME: review error message
        catch (final IOException e) {
          final Runnable showError = () -> showErrorMessage(e, Resources::get_string("Editor.SavedGameUpdaterDialog.fail"), Resources::get_string("Editor.SavedGameUpdaterDialog.unable"));
          try {
  ...
  private void exportPieceInfo() {
    ...
    if (JFileChooser.CANCEL_OPTION != fc.showSaveDialog(this)) {
      ...
      p.put(VERSION_KEY, GameModule.getGameModule().get_game_version());
      ...
      try (OutputStream fout = Files.newOutputStream(fc.getSelectedFile().toPath());
        ...
        showErrorMessage(e, Resources::get_string("Editor.SavedGameUpdaterDialog.ex_fail"), Resources::get_string("Editor.SavedGameUpdaterDialog.ex_unable"));
      }
    }
  }
    ...
    if (JFileChooser.CANCEL_OPTION != fc.showOpenDialog(this)) {
      ...
      try (InputStream fin = Files.newInputStream(fc.getSelectedFile().toPath());
        ...
        if (!GameModule.getGameModule().getGameName().equals(moduleName)) {
          showErrorMessage(null, Resources::get_string("Editor.SavedGameUpdaterDialog.im_fail"), Resources::get_string("Editor.SavedGameUpdaterDialog.im_wrong", moduleName));
          oldPieceInfo = null;
          versionField.setText(null);
        }
        else if (GameModule.getGameModule().get_game_version().equals(moduleVersion)) {
          showErrorMessage(null, Resources::get_string("Editor.SavedGameUpdaterDialog.im_fail"), Resources::get_string("Editor.SavedGameUpdaterDialog.im_current", moduleVersion));
          oldPieceInfo = null;
          versionField.setText(null);
        }
        else {
      ...
      // FIXME: review error message
        ...
        showErrorMessage(e, Resources::get_string("Editor.SavedGameUpdaterDialog.im_fail"), Resources::get_string("Editor.SavedGameUpdaterDialog.im_unable"));
        oldPieceInfo = null;
      }
      catch (IllegalArgumentException e) { // catches malformed input files
        showErrorMessage(e, Resources::get_string("Editor.SavedGameUpdaterDialog.im_fail"), Resources::get_string("Editor.SavedGameUpdaterDialog.im_malformed"));
        oldPieceInfo = null;
      }
    }
