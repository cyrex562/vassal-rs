...
public class Footprint extends MovementMarkable {
  ...
  protected static final String DEFAULT_MENU_COMMAND = Resources::get_string("Editor.Footprint.movement_trail");
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.Footprint.trait_description");
  }
      ...
      while (piece != null) {
        if ((piece instanceof FreeRotator) || (piece instanceof Pivot) || ((piece instanceof MatCargo) && (((MatCargo) piece).maintainRelativeFacing))) {
          ...
          if ((name == null) || name.isEmpty()) {
            name = Resources::get_string("Decorator.prototype");
          }
          ErrorDialog.dataWarning(new BadDataReport(Resources::get_string("Decorator.trails_inside_rotate", getBaseDescription(), piece.getBaseDescription()), name));
        }
  ...
  public PieceI18nData getI18nData() {
    ...
    data.add(menuCommand, Resources::get_string("Editor.Footprint.show_movement_trail_command"));
    return data;
  }
