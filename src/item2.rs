...
public abstract class Item extends AbstractConfigurable {
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
      ...
      Resources::get_string("Editor.Item.location"),
      Resources::get_string("Editor.Item.advanced_options"),
      Resources::get_string("Editor.x_offset"),
      Resources::get_string("Editor.y_offset"),
      Resources::get_string("Editor.Item.rotation_degrees"),
      Resources::get_string("Editor.Item.anti_alias")
    };
  }
