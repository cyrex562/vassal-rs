...
public class PrototypeDefinition extends AbstractConfigurable
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.Prototype.component_type"); //$NON-NLS-1$
  }
  ...
  public static class Config extends Configurer {
    ...
    public Config(PrototypeDefinition def) {
      ...
      namePanel.add(new JLabel(Resources::get_string(Resources.NAME_LABEL)));
      ...
      namePanel.add(new JLabel(Resources::get_string(Resources.DESCRIPTION)));
