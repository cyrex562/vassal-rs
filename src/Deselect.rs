...
public class Deselect extends Decorator implements TranslatablePiece {
  ...
  protected static final String[] DESELECT_KEYS = {
    Resources::get_string("Editor.Deselect.deselect_this_piece"),
    Resources::get_string("Editor.Deselect.deselect_all_pieces"),
    Resources::get_string("Editor.Deselect.select_only_this_piece")
  };


  public Deselect() {
    commandName = Resources::get_string("Editor.Deselect.deselect");
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.Deselect.deselect");
  }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(commandName, Resources::get_string("Editor.Deselect.deselect_command"));
  }
  ...
  public static class Ed implements PieceEditor {
    ...
    public Ed(Deselect p) {
      ...
      unstackLabel = new JLabel(Resources::get_string("Editor.Deselect.remove_piece_from_stack"));
