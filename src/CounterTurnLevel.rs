...
public class CounterTurnLevel extends TurnLevel {
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.addAll(
      super.getAttributeDescriptions(),
        Resources::get_string("Editor.CounterTurnLevel.start_value"),
        Resources::get_string("Editor.CounterTurnLevel.increment_by"),
        Resources::get_string("Editor.CounterTurnLevel.loop"),
        Resources::get_string("Editor.CounterTurnLevel.maximum_value")
    );
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.CounterTurnLevel.component_type");
  }
