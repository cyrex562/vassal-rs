...
public class TranslateWindow extends JDialog implements ListSelectionListener,
  ...
  protected void initComponents() {
    setTitle(Resources::get_string("Editor.TranslateWindow.translate", ConfigureTree.getConfigureName((Configurable) target)));
  ...
  protected Component getHeaderPanel() {
    ...
    langPanel.add(new JLabel(Resources::get_string("Editor.TranslateWindow.language")));
    ...
    final JButton addButton = new JButton(Resources::get_string("Editor.TranslateWindow.add_translation"));
  ...
  protected void refreshTranslationList(Configurable target) {
    final List<Language> list = GameModule.getGameModule().get_components_of(Language.class);
    if (list != null) {
  ...
  protected Component getButtonPanel() {
    ...
    final JButton helpButton = new JButton(Resources::get_string(Resources.HELP));
    ...
    okButton.addActionListener(e -> {
      try {
        ...
        WriteErrorDialog.error(e1,
          GameModule.getGameModule().getArchiveWriter().get_name());
      }
    });
  ...
  protected boolean querySave() throws IOException {
    switch (JOptionPane.showConfirmDialog(this, Resources::get_string("Editor.TranslateWindow.save_now"),
      Resources::get_string("Editor.TranslateWindow.unsaved"), JOptionPane.YES_NO_CANCEL_OPTION)) {
...
//        expanded, leaf, row, false);
  ...
  class MyTableModel extends AbstractTableModel {
    ...
    public String getColumnName(int col) {
      switch (col) {
      case ATTR_COL:
        return Resources::get_string("Editor.TranslateWindow.attribute");
      case SOURCE_COL:
        return Resources::get_string("Editor.TranslateWindow.source_text");
      case CC_COL:
        return Resources::get_string("Editor.TranslateWindow.cc");
      case TRAN_COL:
        return Resources::get_string("Editor.TranslateWindow.translation");
      }
      return null;
    }
