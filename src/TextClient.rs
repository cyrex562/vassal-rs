        ...
        try {
          while ((s = input.readLine()) != null) {
            if (s.startsWith("-room")) {
              ...
              s = "CHAT<" + client.getClient().getUserInfo().get_name()
                                           + "> - " + s;
              client.shout(s);
            }
              ...
              try {
                ...
                msg.append("CHAT<" + client.getClient().getUserInfo().get_name()
                                           + "> ("+length+" chars) -");
              ...
              String msg = " - <" + client.getClient().getUserInfo().get_name()
                                           + "> - " + s;
