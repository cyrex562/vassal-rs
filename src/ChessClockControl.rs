...
public class ChessClockControl extends AbstractConfigurable
  ...
  public static final String CHESSMENU_PAUSE = Resources::get_string("ChessClock.pause"); //NON-NLS
  public static final String CHESSMENU_SHOW  = Resources::get_string("ChessClock.show"); //NON-NLS
  public static final String CHESSMENU_HIDE  = Resources::get_string("ChessClock.hide"); //NON-NLS
  public static final String CHESSMENU_NEXT  = Resources::get_string("ChessClock.next"); //NON-NLS

  public static final String COMMAND_PREFIX = "CLOCKCONTROL" + DELIMITER; //NON-NLS-1$

  public ChessClockControl() {
    setConfigureName(Resources::get_string("Editor.ChessClock.chess_clock_control"));
    ...
    chessClockButton.setToolTipText(Resources::get_string("Editor.tooltip_text_label"));
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.ChessClock.chess_clock_control");
  }
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
      ...
      Resources::get_string("Editor.tooltip_text_label"),
      Resources::get_string("Editor.ChessClock.show_clocks_hotkey"),
      Resources::get_string("Editor.ChessClock.start_next_clock_hotkey"),
      Resources::get_string("Editor.ChessClock.pause_all_clocks_hotkey"),
      Resources::get_string("Editor.ChessClock.show_tenths_of_seconds"),
      Resources::get_string("Editor.ChessClock.show_seconds"),
      Resources::get_string("Editor.ChessClock.show_hours"),
      Resources::get_string("Editor.ChessClock.show_days"),
      Resources::get_string("Editor.ChessClock.allow_reset")
    };
  }
  ...
  public String getAttributeValueString(String key) {
    if (NAME.equals(key)) {
      ...
      return NamedHotKeyConfigurer.encode(pauseListener.get_namedKeyStroke());
    }
    else if (SHOW_HOTKEY.equals(key)) {
      return NamedHotKeyConfigurer.encode(showListener.get_namedKeyStroke());
    }
    else if (SHOW_TENTHSECONDS.equals(key)) {
  ...
  private class ChessMouseListener implements MouseListener, ActionListener {
    ...
    void buildPopup() {
      ...
      if (getClocksTicking() > 0) {
        s = CHESSMENU_PAUSE + "  " + NamedHotKeyConfigurer.getString(pauseListener.get_namedKeyStroke());
      }
      else {
        if (getChessClocksVisible()) {
          s = CHESSMENU_HIDE + "  " + NamedHotKeyConfigurer.getString(showListener.get_namedKeyStroke());
        }
        else {
          s = CHESSMENU_SHOW + "  " + NamedHotKeyConfigurer.getString(showListener.get_namedKeyStroke());
        }
      }
      ...
      item = new JMenuItem(CHESSMENU_NEXT + "  " + NamedHotKeyConfigurer.getString(nextListener.get_namedKeyStroke()));
      item.addActionListener(this);
      popup.add(item);
    }
