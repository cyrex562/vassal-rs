...
public class PieceDefiner extends JPanel {
  ...
  public PieceDefiner(String id, GpIdSupport s) {
    this();
    pieceId = id;
    pieceIdLabel.setText(Resources::get_string("Editor.id") + ": " + id);
    gpidSupport = s;
  }
    ...
    public void keyTyped(KeyEvent e) {
      ...
      for (int i = 0; i < msize; i++) {
        ...
        if (trait instanceof EditablePiece) {
          ...
          final String s = trait.getClass().get_name();
  ...
  private void initComponents() {
    ...
    availableScroll.setBorder(BorderFactory.createTitledBorder(Resources::get_string("Editor.PieceDefiner.available_traits")));
    ...
    helpButton = new JButton(Resources::get_string("General.help"));
    helpButton.setToolTipText(Resources::get_string("Editor.PieceDefiner.help_tip"));
    helpButton.addActionListener(evt -> showHelpForPiece());

    final JButton importButton = new JButton(Resources::get_string("General.import"));
    importButton.setToolTipText(Resources::get_string("Editor.PieceDefiner.import_tip"));
    importButton.addActionListener(evt -> {
      final String className = JOptionPane.showInputDialog(
        this, Resources::get_string("Editor.PieceDefiner.enter_class")
      );
    ...
    addButton = new JButton(Resources::get_string("Editor.PieceDefiner.add"), IconFactory.getIcon("go-next", IconFamily.SMALL)); // NON-NLS
    addButton.setHorizontalTextPosition(SwingUtilities.LEFT);
    addButton.setMargin(buttonInsets);
    addButton.setToolTipText(Resources::get_string("Editor.PieceDefiner.add_tip"));
    addButton.addActionListener(evt -> doAdd());
    addRemovePanel.add(addButton, "sg"); // NON-NLS

    removeButton = new JButton(Resources::get_string("Editor.PieceDefiner.remove"), IconFactory.getIcon("go-previous", IconFamily.SMALL)); // NON-NLS
    removeButton.setMargin(buttonInsets);
    removeButton.setToolTipText(Resources::get_string("Editor.PieceDefiner.remove_tip"));
...
// FIXME: mouseClicked()?
    ...
    inUseScroll.setBorder(BorderFactory.createTitledBorder(Resources::get_string("Editor.PieceDefiner.current_traits")));
    ...
    copyButton = new JButton(Resources::get_string("Editor.copy") + " (" + getCtrlKeyName('C') + ")");
    copyButton.addActionListener(evt -> doCopy());
    inUseButtonPanel.add(copyButton, "sg 1"); // NON-NLS

    pasteButton = new JButton(Resources::get_string("Editor.paste") + " (" + getCtrlKeyName('V') + ")");
    pasteButton.addActionListener(evt -> doPaste());
    inUseButtonPanel.add(pasteButton, "sg 1"); // NON-NLS

    propsButton = new JButton(Resources::get_string("Editor.properties"));
    ...
    moveTopButton = new JButton(Resources::get_string("Editor.PieceDefiner.move_top"), IconFactory.getIcon("go-top", IconFamily.SMALL)); // NON-NLS
    moveTopButton.setToolTipText(Resources::get_string("Editor.PieceDefiner.top_tip"));
    ...
    moveUpButton = new JButton(Resources::get_string("Editor.PieceDefiner.move_up"), IconFactory.getIcon("go-up", IconFamily.SMALL)); // NON-NLS
    moveUpButton.setToolTipText(Resources::get_string("Editor.PieceDefiner.up_tip"));
    ...
    moveDownButton = new JButton(Resources::get_string("Editor.PieceDefiner.move_down"), IconFactory.getIcon("go-down", IconFamily.SMALL)); // NON-NLS
    moveDownButton.setToolTipText(Resources::get_string("Editor.PieceDefiner.down_tip"));
    ...
    moveBottomButton = new JButton(Resources::get_string("Editor.PieceDefiner.move_bottom"), IconFactory.getIcon("go-bottom", IconFamily.SMALL)); // NON-NLS
    moveBottomButton.setToolTipText(Resources::get_string("Editor.PieceDefiner.bottom_trait"));
    ...
    final JLabel noteLabel = new JLabel(Resources::get_string("Editor.PieceDefiner.note1"));
  ...
  protected static class Ed extends JDialog {
    ...
    private Ed(Frame owner, final EditablePiece p) {
      super(owner, Resources::get_string("Editor.PieceDefiner.properties", p.getDescription()), true);
      initialize(p);
    }
    ...
    private void initialize(final EditablePiece p) {
      ...
      final JButton ok = new JButton(Resources::get_string("General.ok"));
      ok.addActionListener(evt -> dispose());

      buttonBox.add(ok, "sg,tag ok"); //NON-NLS

      final JButton cancel = new JButton(Resources::get_string("General.cancel"));
      ...
      if (p.getHelpFile() != null) {
        final JButton help = new JButton(Resources::get_string("General.help"));
  ...
  private static class Renderer extends DefaultListCellRenderer {
    ...
    public Component getListCellRendererComponent(
      ...
      if (value instanceof EditablePiece) {
        ...
        final String s = value.getClass().get_name();
  ...
  static class ListTransferHandler extends TransferHandler {
    ...
    public boolean canImport(TransferHandler.TransferSupport info) {
      ...
      if (AVAILABLE.equals((info.getComponent()).get_name())) {
        return false;
      }
      else {
