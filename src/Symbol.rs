...
public class Symbol {
  ...
  public static class NatoUnitSymbolSet {
    ...
    public static final SizeOption[] SIZES = {
      new SizeOption(SZ_NONE, Resources::get_string("Editor.Symbol.Size.none"), 0, ""), //$NON-NLS-1$
      new SizeOption(SZ_INSTALLATION, Resources::get_string("Editor.Symbol.Size.installation"), 1, INSTALLATION_SYMBOL),
      new SizeOption(SZ_TEAM, Resources::get_string("Editor.Symbol.Size.team"), 1, TEAM_SYMBOL),
      new SizeOption(SZ_SQUAD, Resources::get_string("Editor.Symbol.Size.squad"), 1, SQUAD_SYMBOL),
      new SizeOption(SZ_SECTION, Resources::get_string("Editor.Symbol.Size.platoon"), 3, SQUAD_SYMBOL),
      new SizeOption(SZ_ECHELON, Resources::get_string("Editor.Symbol.Size.echelon"), 4, SQUAD_SYMBOL),
      new SizeOption(SZ_COMPANY, Resources::get_string("Editor.Symbol.Size.company"), 1, COMPANY_SYMBOL),
      new SizeOption(SZ_BATTALION, Resources::get_string("Editor.Symbol.Size.battalion"), 2, COMPANY_SYMBOL),
      new SizeOption(SZ_REGIMENT, Resources::get_string("Editor.Symbol.Size.regiment"), 3, COMPANY_SYMBOL),
      new SizeOption(SZ_BRIGADE, Resources::get_string("Editor.Symbol.Size.brigade"), 1, BRIGADE_SYMBOL),
      new SizeOption(SZ_DIVISION, Resources::get_string("Editor.Symbol.Size.division"), 2, BRIGADE_SYMBOL),
      new SizeOption(SZ_CORPS, Resources::get_string("Editor.Symbol.Size.corps"), 3, BRIGADE_SYMBOL),
      new SizeOption(SZ_ARMY, Resources::get_string("Editor.Symbol.Size.army"), 4, BRIGADE_SYMBOL),
      new SizeOption(SZ_ARMY_GROUP, Resources::get_string("Editor.Symbol.Size.army_group"), 5, BRIGADE_SYMBOL),
      new SizeOption(SZ_REGION, Resources::get_string("Editor.Symbol.Size.region"), 6, BRIGADE_SYMBOL)
    };
