...
public class NotesWindow extends AbstractToolbarItem
  ...
  public NotesWindow() {
    ...
    frame.setTitle(Resources::get_string("Notes.notes")); //$NON-NLS-1$
    ...
    setLaunchButton(makeLaunchButton(
      Resources::get_string("Notes.notes"),
      Resources::get_string("Notes.notes"),
  ...
  protected class NotesDialog extends JDialog {
    ...
    protected void initComponents() {
      ...
      b.add(new JLabel(Resources::get_string("Notes.visible_to_all"))); //$NON-NLS-1$
      b.add(scenarioNotes.getControls());
      tab.addTab(Resources::get_string("Notes.scenario"), b); //$NON-NLS-1$

      b = Box.createVerticalBox();
      b.add(new JLabel(Resources::get_string("Notes.visible_to_all"))); //$NON-NLS-1$
      b.add(publicNotes.getControls());
      tab.addTab(Resources::get_string("Notes.public"), b); //$NON-NLS-1$

      tab.addTab(Resources::get_string("Notes.private"), privateNotes.getControls()); //$NON-NLS-1$

      tab.addTab(Resources::get_string("Notes.delayed"), secretNotes.getControls()); //$NON-NLS-1$
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.NotesWindow.component_type"); //$NON-NLS-1$
  }
