...
public class SymbolItem extends Item {
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.insert(
      ...
      Resources::get_string("Editor.SymbolItem.symbol_set"),
      Resources::get_string("Editor.width"),
      Resources::get_string("Editor.height"),
      Resources::get_string("Editor.SymbolItem.line_width")
    );
  }
  ...
  public String getDisplayName() {
    return Resources::get_string("Editor.SymbolItem.component_type");
  }
