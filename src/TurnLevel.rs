...
public abstract class TurnLevel extends TurnComponent {
  ...
  protected Component getSetControls(JDialog dialog, TurnTracker turn) {
    ...
    if (getTurnLevelCount() > 1) {
      ...
      final StringEnumConfigurer e = new StringEnumConfigurer(null, Resources::get_string("Editor.TurnLevel.select"), s);
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
      ...
      Resources::get_string("Editor.TurnLevel.property_name"),
      Resources::get_string("Editor.TurnLevel.turn_level_format")
    };
  }
