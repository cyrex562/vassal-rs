...
public class SendToLocation extends Decorator implements TranslatablePiece {
  ...
  public static final String[] DEST_KEYS = {
    Resources::get_string("Editor.SendToLocation.grid_location_on_selected_map"),
    Resources::get_string("Editor.SendToLocation.location_on_selected_map"),
    Resources::get_string("Editor.SendToLocation.zone_on_selected_map"),
    Resources::get_string("Editor.SendToLocation.region_on_selected_map"),
    Resources::get_string("Editor.SendToLocation.another_counter_selected_by_properties_any"),
    Resources::get_string("Editor.SendToLocation.another_counter_selected_by_properties_cycle"),
    Resources::get_string("Editor.SendToLocation.another_counter_selected_by_properties_nearest")
  };
  ...
  protected KeyCommand[] myGetKeyCommands() {
    ...
    for (final KeyCommand c : command) {
      if (c.get_name().equals(backCommandName)) {
    ...
    // Location/Zone/Region processing all use specified map
      ...
      if (map != null) {
        ...
        case 'G':
          ...
          if (b != null) {
            final AuditTrail gridAudit = AuditTrail.create(auditSource, gridLocation, Resources::get_string("Editor.SendToLocation.grid_location"));
            try {
              ...
              if (g != null) { // Board may not have a grid assigned.
                ...
                if (auditSource instanceof EditablePiece) {
                  reportDataError((EditablePiece)auditSource, Resources::get_string("Error.no_grid_assigned"), map.getMapName(), new AuditableException(auditSource, gridAudit));
                }
                else if (auditSource instanceof AbstractConfigurable) {
                  ErrorDialog.dataWarning(new BadDataReport((AbstractConfigurable)auditSource, Resources::get_string("Error.no_grid_assigned"), map.getMapName(), new AuditableException(auditSource, gridAudit)));
                }
              }
            }
            catch (BadCoords e) {
              if (auditSource instanceof EditablePiece) {
                reportDataError((EditablePiece)auditSource, Resources::get_string(
                  "Error.not_found", Resources::get_string("Editor.SendToLocation.grid_location")), map.getMapName(), new AuditableException(auditSource, gridAudit));
              }
              else if (auditSource instanceof AbstractConfigurable) {
                ErrorDialog.dataWarning(new BadDataReport(Resources::get_string(
                  "Error.not_found", Resources::get_string("Editor.SendToLocation.grid_location")), map.getMapName(), new AuditableException(auditSource, gridAudit)));
              }
        ...
        case 'L':
          ...
          final int yValue;
          if (auditSource instanceof EditablePiece) {
            xValue = x.getTextAsInt(source, Resources::get_string("Editor.x_position"), (EditablePiece)auditSource);
            yValue = y.getTextAsInt(source, Resources::get_string("Editor.y_position"), (EditablePiece)auditSource);
          }
          else if (auditSource instanceof AbstractConfigurable) {
            xValue = x.getTextAsInt(source, Resources::get_string("Editor.x_position"), (AbstractConfigurable) auditSource);
            yValue = y.getTextAsInt(source, Resources::get_string("Editor.y_position"), (AbstractConfigurable) auditSource);
          }
          else {
            xValue = 0;
            yValue = 0;
        ...
        case 'Z':
          final AuditTrail zoneAudit = AuditTrail.create(auditSource, zone, Resources::get_string("Editor.SendToLocation.zone_name"));
          final String zoneName = zone.getText(source, auditSource, zoneAudit);
          final Zone z = map.findZone(zoneName);
          if (z == null) {
            if (auditSource instanceof EditablePiece) {
              reportDataError((EditablePiece)auditSource, Resources::get_string("Error.not_found", "Zone"), zone.debugInfo(zoneName, "Zone"), new AuditableException(auditSource, zoneAudit)); // NON-NLS
            }
            else if (auditSource instanceof AbstractConfigurable) {
              ErrorDialog.dataWarning(new BadDataReport((AbstractConfigurable)auditSource, Resources::get_string("Error.not_found", "Zone"), zone.debugInfo(zoneName, "Zone"), new AuditableException(auditSource, zoneAudit))); // NON-NLS
            }
          }
          else {
        ...
        case 'R':
          final AuditTrail regionAudit = AuditTrail.create(auditSource, region, Resources::get_string("Editor.SendToLocation.region_name"));
          final String regionName = region.getText(source, auditSource, regionAudit);
          final Region r = map.findRegion(regionName);
          if (r == null) {
            if (auditSource instanceof EditablePiece) {
              reportDataError((EditablePiece) auditSource, Resources::get_string("Error.not_found", "Region"), region.debugInfo(regionName, "Region"), new AuditableException(auditSource, regionAudit)); // NON-NLS
            }
            else if (auditSource instanceof AbstractConfigurable) {
              ErrorDialog.dataWarning(new BadDataReport((AbstractConfigurable)auditSource, Resources::get_string("Error.not_found", "Zone"), region.debugInfo(regionName, "Zone"), new AuditableException(auditSource, regionAudit))); // NON-NLS
            }
          }
          else {
  ...
  private int parse(String desc, FormattedString s, GamePiece outer) {
    ...
    try {
      ...
      reportDataError(this, Resources::get_string("Error.non_number_error"), s.debugInfo(val, desc), e);
    }
    return i;
  }
  ...
  public void mySetState(String newState) {
    ...
    if (x.length() > 0 && y.length() > 0) {
      try {
        ...
        reportDataError(this, Resources::get_string("Error.non_number_error"),
  ...
  public String getDescription() {
    String d = Resources::get_string("Editor.SendToLocation.trait_description");
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.SendToLocation.trait_description");
  }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(new String[] {commandName, backCommandName},
                       new String[] {getCommandDescription(description, Resources::get_string("Editor.SendToLocation.send_command_description")),
                                     getCommandDescription(description, Resources::get_string("Editor.SendToLocation.back_command_description"))});
  }
  ...
  public static class Ed implements PieceEditor {
    ...
    public Ed(SendToLocation p) {
      ...
      mapLabel = new JLabel(Resources::get_string("Editor.SendToLocation.map"));
      ...
      JButton select = new JButton(Resources::get_string("Editor.select"));
      select.addActionListener(e -> selectMap());
      mapControls.add(select);
      JButton clear = new JButton(Resources::get_string("Editor.clear"));
      clear.addActionListener(e -> clearMap());
      mapControls.add(clear);
      controls.add(mapLabel, mapControls);

      boardLabel = new JLabel(Resources::get_string("Editor.SendToLocation.board"));
      ...
      regionLabel = new JLabel(Resources::get_string("Editor.SendToLocation.region_name"));
      ...
      propertyLabel = new JLabel(Resources::get_string("Editor.property_match_label"));
      propertyInput = new PropertyExpressionConfigurer(p.propertyFilter);
      controls.add(propertyLabel, propertyInput);

      gridLabel = new JLabel(Resources::get_string("Editor.SendToLocation.grid_location"));
      ...
      xAdvancedLabel = new JLabel(Resources::get_string("Editor.SendToLocation.additional_x_offset"));
      ...
      advancedControls.add(new JLabel(Resources::get_string("Editor.SendToLocation.times")));
      ...
      yAdvancedLabel = new JLabel(Resources::get_string("Editor.SendToLocation.additional_y_offset"));
      ...
      yAdvancedControls.add(new JLabel(Resources::get_string("Editor.SendToLocation.times")));
    ...
    private void selectBoard() {
      ...
      if (d.getTarget() != null) {
        ...
        boardNameInput.setValue(b.get_name());
      }
    }
   ...
   */
  @Override
  public List<NamedKeyStroke> get_namedKeyStrokeList() {
