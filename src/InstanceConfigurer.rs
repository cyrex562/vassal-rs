...
public class InstanceConfigurer extends Configurer {
  ...
  protected class SymbolPanel extends JPanel {
    ...
    public SymbolPanel() {
      ...
      box.add(new JLabel(Resources::get_string("Editor.InstanceConfigurer.items")));
      mainPanel.add(box);
    ...
    class SymbolTableModel extends AbstractTableModel {
      ...
      private final String[] columnNames = {
        ...
        Resources::get_string("Editor.InstanceConfigurer.type"),
        Resources::get_string("Editor.InstanceConfigurer.position")
      };
      ...
      public Object getValueAt(int row, int col) {
        if (col == NAME_COL) {
          return getValueList().get(row).get_name();
        }
