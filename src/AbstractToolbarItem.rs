...
public abstract class AbstractToolbarItem extends AbstractConfigurable implements GameComponent, PropertyChangeListener {
  ...
  public String[] getAttributeDescriptions() {
    if (!nameKey.isEmpty()) {
      return new String[]{
        namePrompt.isEmpty() ? Resources::get_string(Resources.DESCRIPTION) : namePrompt,
        ...
        Resources::get_string("Editor.AbstractToolbarItem.can_disable"),
        Resources::get_string("Editor.AbstractToolbarItem.property_gate"),
        Resources::get_string("Editor.AbstractToolbarItem.disabled_icon"),
      };
    }
    else {
      return new String[]{
