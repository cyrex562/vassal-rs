...
public class RegionGrid extends AbstractConfigurable implements MapGrid, ConfigureTree.Mutable {
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      Resources::get_string("Editor.Grid.snap"), //$NON-NLS-1$
      Resources::get_string("Editor.IrregularGrid.draw"), //$NON-NLS-1$
  ...
  public Configurer getConfigurer() {
    ...
    if (!buttonExists) {
      final JButton b = new JButton(Resources::get_string("Editor.IrregularGrid.define_regions")); //$NON-NLS-1$
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.IrregularGrid.component_type"); //$NON-NLS-1$
  }
  ...
  public String locationName(Point p) {
    ...
    return region != null ? region.get_name() : null;
  }
  ...
  public static class Config extends JFrame implements MouseListener, MouseMotionListener, ActionListener, KeyListener {
    ...
    public Config(RegionGrid grid) {
      super(Resources::get_string("Editor.IrregularGrid.regions_for", grid.container.getBoard().get_name())); //$NON-NLS-1$
    ...
    protected void initComponents() {
      ...
      final JButton okButton =
        new JButton(Resources::get_string(Resources.OK));
      okButton.addActionListener(e -> close());
      buttonPanel.add(okButton);

      final JButton canButton =
        new JButton(Resources::get_string(Resources.CANCEL));
      canButton.addActionListener(e -> doCancel());
      buttonPanel.add(canButton);

      final JLabel mess = new JLabel(SystemUtils.IS_OS_MAC ? Resources::get_string("Editor.IrregularGrid.drag_and_drop_mac") : Resources::get_string("Editor.IrregularGrid.drag_and_drop")); //$NON-NLS-1$
      ...
      if (dirty) {
        if (JOptionPane.YES_OPTION ==
          JOptionPane.showConfirmDialog(this,
            Resources::get_string("Editor.IrregularGrid.changes_made"), //$NON-NLS-1$
...
// FIXME: make this an ImageOp?
    ...
    protected static final String ADD_REGION = Resources::get_string("Editor.IrregularGrid.add_region"); //$NON-NLS-1$
    protected static final String DELETE_REGION = Resources::get_string("Editor.IrregularGrid.delete_region"); //$NON-NLS-1$
    protected static final String PROPERTIES = Resources::get_string("Editor.properties"); //$NON-NLS-1$
    protected static final String MOVE_INTO_ZONE = Resources::get_string("Editor.IrregularGrid.move_into_zone");
    protected static final String SHOW_ZONE = Resources::get_string("Editor.IrregularGrid.show_zone");
    protected static final String SELECT_ALL = Resources::get_string("Editor.IrregularGrid.select_all");
        ...
        if (w == null) {
          ...
          w.addWindowListener(new WindowAdapter() {
            ...
            public void windowClosed(WindowEvent e) {
              ...
              owner.setDirty(
                  !region.get_name().equals(origRegion.get_name()) ||
