...
public class SubMenu extends Decorator implements TranslatablePiece {
  ...
  private static final String DEFAULT_MENU_NAME = Resources::get_string("Editor.SubMenu.default_menu_name");
  private String description = "";

  public SubMenu() {
    this(ID + Resources::get_string("Editor.SubMenu.default_menu_name") + ";", null);
  }
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.SubMenu.trait_description");
  }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(getMenuName(), Resources::get_string("Editor.SubMenu.sub_menu.name"));
  }
