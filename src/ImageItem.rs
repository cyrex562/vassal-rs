...
public class ImageItem extends Item {
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.insert(
      ...
      Resources::get_string("Editor.image_label"),
      Resources::get_string("Editor.ImageItem.image_option")
    );
  }
  ...
  public String getDisplayName() {
    return Resources::get_string("Editor.ImageItem.component_type");
  }
