...
public class ReturnToDeck extends Decorator implements TranslatablePiece {
  ...
  protected String selectDeckPrompt = Resources::get_string("Editor.ReturnToDeck.select_destination");
  ...
  public ReturnToDeck() {
    this(ID + Resources::get_string("Editor.ReturnToDeck.default_command") + ";R;", null); // NON-NLS
  }
  ...
  public Command myKeyEvent(KeyStroke stroke) {
    ...
    if (myCommand.matches(stroke)) {
      ...
      if (deckSelect) {
        ...
        final AuditTrail audit = AuditTrail.create(this, deckExpression, Resources::get_string("Editor.ReturnToDeck.deck_name"));
  ...
  private DrawPile promptForDrawPile() {
    ...
    d.setTitle(Decorator.getInnermost(this).get_name()); //$NON-NLS-1$
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.ReturnToDeck.trait_description");
  }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(returnCommand, Resources::get_string("Editor.ReturnToDeck.return_to_deck_command"));
  }
  ...
  private static class Ed implements PieceEditor {
    ...
    public Ed(ReturnToDeck p) {
      ...
      selectLabel = new JLabel(Resources::get_string("Editor.ReturnToDeck.deck_name"));
      deckExp = new DeckSelectionConfigurer(p.deckExpression.getFormat(), p);
      controls.add(selectLabel);
      controls.add(deckExp.getControls(), "split 2"); //NON-NLS

      promptLabel = new JLabel(Resources::get_string("Editor.ReturnToDeck.prompt_for_destination_deck"));
