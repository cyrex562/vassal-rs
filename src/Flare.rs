...
public class Flare extends AbstractConfigurable
  ...
  public static final String FLARE_ALT_LOCAL       = Resources::get_string("Editor.Flare.flare_key_desc", Resources::get_string("Keys.alt"));                       //$NON-NLS-1$ //$NON-NLS-2$
  public static final String FLARE_CTRL_LOCAL      = Resources::get_string("Editor.Flare.flare_key_desc", Resources::get_string("Keys.ctrl"));                      //$NON-NLS-1$ //$NON-NLS-2$
  public static final String FLARE_COMMAND_LOCAL   = Resources::get_string("Editor.Flare.flare_key_desc", Resources::get_string("Keys.meta"));                      //$NON-NLS-1$ //$NON-NLS-2$
  public static final String FLARE_ALT_SHIFT_LOCAL = Resources::get_string("Editor.Flare.flare_key_desc", Resources::get_string("Keys.alt_shift"));                 //$NON-NLS-1$ //$NON-NLS-2$
  public static final String FLARE_SHIFT_COMMAND_LOCAL = Resources::get_string("Editor.Flare.flare_key_desc", Resources::get_string("Keys.shift_command"));         //$NON-NLS-1$ //$NON-NLS-2$
  public static final String FLARE_CTRL_SHIFT_LOCAL = Resources::get_string("Editor.Flare.flare_key_desc", Resources::get_string("Keys.ctrl_shift"));               //$NON-NLS-1$ //$NON-NLS-2$
  public static final String FLARE_ALT_COMMAND_LOCAL = Resources::get_string("Editor.Flare.flare_key_desc", Resources::get_string("Keys.alt_command"));             //$NON-NLS-1$ //$NON-NLS-2$
  public static final String FLARE_CTRL_ALT_LOCAL = Resources::get_string("Editor.Flare.flare_key_desc", Resources::get_string("Keys.ctrl_alt"));                   //$NON-NLS-1$ //$NON-NLS-2$
  public static final String FLARE_ALT_SHIFT_COMMAND_LOCAL = Resources::get_string("Editor.Flare.flare_key_desc", Resources::get_string("Keys.alt_shift_command")); //$NON-NLS-1$ //$NON-NLS-2$
  public static final String FLARE_CTRL_ALT_SHIFT_LOCAL = Resources::get_string("Editor.Flare.flare_key_desc", Resources::get_string("Keys.ctrl_alt_shift"));       //$NON-NLS-1$ //$NON-NLS-2$
  ...
  public Flare() {
    ...
    pulses       = 6;
    pulsesPerSec = 3;
    setConfigureName(Resources::get_string("Editor.Flare.desc"));
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.Flare.configure"); //$NON-NLS-1$
  }
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
      Resources::get_string("Editor.name_label"), //$NON-NLS-1$
      Resources::get_string(Resources.DESCRIPTION),
      Resources::get_string("Editor.Flare.flare_key"), //$NON-NLS-1$
      Resources::get_string("Editor.Flare.circle_size"), //$NON-NLS-1$
      Resources::get_string("Editor.Flare.circle_color"), //$NON-NLS-1$
      Resources::get_string("Editor.Flare.circle_scale"), //$NON-NLS-1$
      Resources::get_string("Editor.Flare.pulses"), //$NON-NLS-1$
      Resources::get_string("Editor.Flare.pulses_per_sec"), //$NON-NLS-1$
      Resources::get_string("Editor.report_format") //$NON-NLS-1$
    };
  }
    ...
    if (parent instanceof Map) {
      ...
      g.getPrefs().addOption(
        ...
        new BooleanConfigurer(
          NO_ANIMATION,
          Resources::get_string("Flare.no_animation"), // $NON-NLS-1$
          Boolean.FALSE
        )
      );
    }
  ...
  public void mousePressed(final MouseEvent e) {
    ...
    reportFormat.setProperty(FLARE_ZONE, (z != null) ? z.get_name() : "");
