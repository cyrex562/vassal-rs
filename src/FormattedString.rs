...
public class FormattedString implements Loopable {
  ...
  public String getText(Auditable owner, String fieldKey) {
    return getText(fsdata.defaultProperties, false, owner, AuditTrail.create(owner, getFormat(), Resources::get_string(fieldKey)));
  }
  ...
  public String getLocalizedText(Auditable owner, String fieldKey) {
    return getText(fsdata.defaultProperties, true, owner, AuditTrail.create(owner, getFormat(), Resources::get_string(fieldKey)));
  }
  ...
  public String getText(PropertySource ps, Auditable owner, String fieldKey) {
    return getText(ps, false, owner, AuditTrail.create(owner, fsdata.formatString, Resources::get_string(fieldKey)));
  }
  ...
  public String getText(PropertySource ps, String def, Auditable owner, String fieldKey) {
    return  getText(ps, def, owner, AuditTrail.create(owner, getFormat(), Resources::get_string(fieldKey)));
  }
  ...
  public String getLocalizedText(PropertySource ps, Auditable owner, String fieldKey) {
    return getText(ps, true, owner, AuditTrail.create(owner, fsdata.formatString, Resources::get_string(fieldKey)));
  }
  ...
  public String getText(PropertySource ps, boolean localized, Auditable owner, AuditTrail audit) {
    ...
    try {
      ...
      ErrorDialog.dataWarning(new BadDataReport(
        Resources::get_string("Error.possible_infinite_string_loop"),
  ...
  public int getTextAsInt(PropertySource ps, String description, EditablePiece source, Auditable owner, AuditTrail audit) {
    ...
    try {
      ...
      ErrorDialog.dataWarning(new BadDataReport(
        source,
        Resources::get_string("Error.non_number_error"),
  ...
  public String getComponentTypeName() {
    return Resources::get_string("Editor.FormattedString.component_type");
  }
