...
public class CgiServerStatus implements ServerStatus {
  ...
  private static final String[] times = {
    Resources::get_string(LAST_DAY),
    Resources::get_string(LAST_WEEK),
    Resources::get_string(LAST_MONTH)
  };
  ...
  public CgiServerStatus() {
    ...
    timeRanges.put(Resources::get_string(LAST_DAY), DAY);
    timeRanges.put(Resources::get_string(LAST_WEEK), DAY * 7);
    timeRanges.put(Resources::get_string(LAST_MONTH), DAY * 30);
  }
