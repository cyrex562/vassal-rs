...
public class PieceMover extends AbstractBuildable
  ...
  protected void initButton() {
    ...
    if (GlobalOptions.PROMPT.equals(value)) {
      final BooleanConfigurer config = new BooleanConfigurer(
        Map.MARK_MOVED, Resources::get_string("Editor.PieceMover.mark_moved_pieces"), Boolean.TRUE);
  ...
  static {
    try {
      Class.forName(MovementReporter.class.get_name());
      Class.forName(KeyBuffer.class.get_name());
    }
