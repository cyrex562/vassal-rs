...
public class ExpressionInterpreter extends AbstractInterpreter implements Loopable {
  ...
  public String getComponentTypeName() {
    return Resources::get_string("Editor.ExpressionInterpreter.component_type");
  }
  ...
  protected void initialiseStatic() {
    ...
    get_nameSpace().importClass("VASSAL.build.module.properties.PropertySource");
    get_nameSpace().importClass("VASSAL.script.ExpressionInterpreter");
  ...
  public String evaluate(PropertySource ps, java.util.Map<String, String> properties, boolean localized, Auditable owner, AuditTrail audit) throws ExpressionException {
    ...
    try {
      ...
      try {
        ...
        if (audit != null) {
          audit.addMessage(Resources::get_string("Audit.error_trail", m));
        }
      ...
      result = "";
      ErrorDialog.dataWarning(new BadDataReport(Resources::get_string("Error.possible_infinite_expression_loop"), getExpression(), e));
    }
    finally {
