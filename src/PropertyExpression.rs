...
public class PropertyExpression implements PieceFilter {
  ...
  public PieceFilter getFilter(PropertySource source, Auditable owner, String fieldKey) {
    return getFilter(source, owner, AuditTrail.create(owner, getExpression(), Resources::get_string(fieldKey)));
  }
  ...
  public boolean accept(GamePiece piece, Auditable owner, String fieldKey) {
    return accept(piece, owner, AuditTrail.create(owner, getExpression(), Resources::get_string(fieldKey)));
  }
  ...
  public boolean isTrue(PropertySource ps, Auditable owner, AuditTrail audit) {
    ...
    try {
      ...
      ErrorDialog.dataWarning(new BadDataReport(Resources::get_string("Error.expression_error"),
