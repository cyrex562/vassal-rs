...
public class UpdateCheckAction extends AbstractAction {
  ...
  public UpdateCheckAction(Frame frame) {
    super(Resources::get_string("UpdateCheckAction.update_check"));
    this.frame = frame;
  }
      ...
      try {
        ...
        if (!update) {
          ...
          JOptionPane.showMessageDialog(
            frame,
            Resources::get_string("UpdateCheckAction.version_current_message"),
            Resources::get_string("UpdateCheckAction.version_current_title"),
          ...
          if (JOptionPane.showConfirmDialog(
              frame,
              Resources::get_string("UpdateCheckAction.update_available_message"),
              Resources::get_string("UpdateCheckAction.update_available_title"),
