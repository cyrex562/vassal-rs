...
public class TextSaver extends AbstractToolbarItem {
  ...
  public TextSaver() {
    ...
    setLaunchButton(makeLaunchButton(
      Resources::get_string("Editor.TextSaver.save_tooltip"),
      Resources::get_string("Editor.TextSaver.save_text"),
      "",
      e -> apply()
    ));
  ...
  public void apply() {
    switch (JOptionPane.showConfirmDialog(GameModule.getGameModule().getPlayerWindow(), Resources::get_string("Editor.TextSaver.by_opponents"), "", JOptionPane.YES_NO_OPTION)) {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.TextSaver.component_type"); //$NON-NLS-1$
  }
