...
public class SelectionHighlighter extends AbstractConfigurable implements Highlighter {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.SelectionHighlight.component_type"); //$NON-NLS-1$
  }
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
        ...
        Resources::get_string("Editor.SelectionHighlight.active_property"), //$NON-NLS-1$
        Resources::get_string("Editor.SelectionHighlight.use_image"), //$NON-NLS-1$
        Resources::get_string("Editor.border_color"), //$NON-NLS-1$
        Resources::get_string("Editor.border_thickness"), //$NON-NLS-1$
