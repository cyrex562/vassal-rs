...
public class TabWidget extends Widget
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.TabWidget.component_type");
  }
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{Resources::get_string("Editor.name_label"), Resources::get_string(Resources.DESCRIPTION)};
  }
