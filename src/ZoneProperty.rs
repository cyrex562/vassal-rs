...
public class ZoneProperty extends GlobalProperty {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.ZoneProperty.component_type");
  }
  ...
  protected String getPropertyId() {
    final String zoneName = parentZone == null ? null : parentZone.get_name();
    final Board board = parentZone == null ? null : parentZone.getBoard();
    final String boardName = board == null ? null : board.get_name();
