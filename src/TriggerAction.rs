...
public class TriggerAction extends Decorator implements TranslatablePiece,
  ...
  public Command myKeyEvent(KeyStroke stroke) {
    ...
    if (LoopControl.LOOP_COUNTED.equals(loopType)) {
      loopCountLimit = loopCount.getTextAsInt(outer, Resources::get_string("Editor.LoopControl.loop_count"), this); //$NON-NLS-1$
    }
  ...
  private int parse(String fieldKey, FormattedString s, GamePiece outer) {
    ...
    try {
      ...
      reportDataError(this, Resources::get_string("Error.non_number_error"), s.debugInfo(val, Resources::get_string(fieldKey)), e);
    }
    return i;
  }
  ...
  public String getDescription() {
    String s = Resources::get_string("Editor.TriggerAction.trait_description"); //$NON-NLS-1$
    if (name.length() > 0) {
      s += " - " + name; //$NON-NLS-1$
    }
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.TriggerAction.trait_description");
  }
  ...
  public static class Ed implements PieceEditor {
    ...
    public Ed(TriggerAction piece) {
      ...
      loopTypeLabel = new JLabel(Resources::get_string("Editor.LoopControl.type_of_loop"));
      ...
      loopCountLabel = new JLabel(Resources::get_string("Editor.LoopControl.loop_how_many"));
      ...
      whileLabel = new JLabel(Resources::get_string("Editor.TriggerAction.looping_continues"));
      ...
      untilLabel = new JLabel(Resources::get_string("Editor.TriggerAction.looping_ends"));
      ...
      preLabel = new JLabel(Resources::get_string("Editor.TriggerAction.keystroke_before"));
      preLoopKeyConfig = new NamedHotKeyConfigurer(piece.preLoopKey);
      box.add(preLabel, preLoopKeyConfig);

      postLabel = new JLabel(Resources::get_string("Editor.TriggerAction.keystroke_after"));
      postLoopKeyConfig = new NamedHotKeyConfigurer(piece.postLoopKey);
      box.add(postLabel, postLoopKeyConfig);

      indexLabel = new JLabel(Resources::get_string("Editor.LoopControl.loop_index"));
      ...
      indexPropertyLabel = new JLabel(Resources::get_string("Editor.LoopControl.index_name"));
      ...
      indexStartLabel = new JLabel(Resources::get_string("Editor.LoopControl.index_start"));
      ...
      indexStepLabel = new JLabel(Resources::get_string("Editor.LoopControl.index_step"));
