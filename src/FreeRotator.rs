...
public class FreeRotator extends Decorator
  ...
  protected String setAngleText = Resources::get_string("Editor.FreeRotator.default_rotate_command");
  protected NamedKeyStroke rotateCWKey;
  protected String rotateCWText = Resources::get_string("Editor.FreeRotator.default_rotate_cw_command");
  protected NamedKeyStroke rotateCCWKey;
  protected String rotateCCWText = Resources::get_string("Editor.FreeRotator.default_rotate_ccw_command");
  protected String name = Resources::get_string("Editor.FreeRotator.default_trait_name");
  ...
  protected String rotateDirectText = Resources::get_string("Editor.FreeRotator.default_rotate_direct_command");
  ...
  public FreeRotator() {
    ...
    this(ID + "6;];[;" + Resources::get_string("Editor.FreeRotator.default_rotate_cw_command") + ";" + Resources::get_string("Editor.FreeRotator.default_rotate_ccw_command") + ";;;;", null); //$NON-NLS-1$//
  }
  ...
  public void mySetState(String state) {
    if (isFreeRotation()) {
      try {
        ...
        reportDataError(this, Resources::get_string("Error.non_number_error"), "Angle=" + state, e); // NON-NLS
      }
    }
    else {
      try {
        ...
        reportDataError(this, Resources::get_string("Error.non_number_error"), "Fixed Angle Index=" + state, e); // NON-NLS
      }
    }
  }
  ...
  public Command myKeyEvent(KeyStroke stroke) {
    ...
    // Direct rotation
      ...
      final AuditTrail audit = AuditTrail.create(this, directExpression, Resources::get_string("Editor.FreeRotator.rotate_direct"));
      final String targetAngleText = directExpression.getText(
        Decorator.getOutermost(this),
        Resources::get_string("Editor.FreeRotator.rotate_direct"),
        this,
        audit
      );
      ...
      if (targetAngleText.isEmpty()) {
        ...
        try {
          ...
          reportDataError(this, Resources::get_string("Error.non_number_error"), "Invalid number: " + targetAngleText, new AuditableException(this, audit));
          targetAngle = (isFreeRotation() || !directTypeFacing) ? 0 : 1;
        }
      }
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.FreeRotator.trait_description");
  }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(
      ...
      new String[] {
        getCommandDescription(name, Resources::get_string("Editor.FreeRotator.set_angle_command_description")),
        getCommandDescription(name, Resources::get_string("Editor.FreeRotator.rotate_cw_command_description")),
        getCommandDescription(name, Resources::get_string("Editor.FreeRotator.rotate_ccw_command_description")),
        getCommandDescription(name, Resources::get_string("Editor.FreeRotator.rotate_random_command_description")),
        getCommandDescription(name, Resources::get_string("Editor.FreeRotator.rotate_direct_command_description"))
      }
    );
  }
  ...
  private static class Ed implements PieceEditor, PropertyChangeListener {
    ...
    public Ed(FreeRotator p) {
      ...
      facingsLabel = new JLabel(Resources::get_string("Editor.FreeRotator.number_of_allowed_facings"));
      facingsConfig = new IntConfigurer(p.isFreeRotation() ? 6 : p.validAngles.length);
      panel.add(facingsLabel, facingsConfig, "wrap"); // NON-NLS

      final JLabel menuLabel = new JLabel(Resources::get_string("Editor.menu_command"));
      ...
      final JLabel keyLabel = new JLabel(Resources::get_string("Editor.keyboard_command"));
      keyLabel.setFont(boldFont);
      panel.add(keyLabel, "grow 0,align center,wrap"); // NON-NLS

      cwLabel = new JLabel(Resources::get_string("Editor.FreeRotator.rotate_clockwise"));
      panel.add(cwLabel);
      ...
      ccwLabel = new JLabel(Resources::get_string("Editor.FreeRotator.rotate_counter_clockwise"));
      panel.add(ccwLabel);
      ...
      anyLabel = new JLabel(Resources::get_string("Editor.FreeRotator.rotate"));
      panel.add(anyLabel);
      ...
      final JLabel rndLabel = new JLabel(Resources::get_string("Editor.FreeRotator.rotate_randomly"));
      panel.add(rndLabel);
      ...
      panel.add(new JLabel(Resources::get_string("Editor.FreeRotator.rotate_directly")));
      ...
      panel.add(new JLabel(Resources::get_string("Editor.FreeRotator.rotate_direct")));
      ...
      toFacingLabel = new JLabel(Resources::get_string("Editor.FreeRotator.rotate_direct_facing"));
    ...
    public void propertyChange(PropertyChangeEvent evt) {
      ...
      directTypeLabel.setText(
        (any || !facingConfig.getValueBoolean()) ?
          Resources::get_string("Editor.FreeRotator.rotate_degrees") :
          Resources::get_string("Editor.FreeRotator.rotate_facing")
      );
