...
public class CounterDetailViewer extends AbstractConfigurable implements Drawable, DragSourceMotionListener, MouseMotionListener, MouseListener, KeyListener {
  ...
  public void addTo(Buildable b) {
    ...
    GameModule.getGameModule().getPrefs().addOption(
      Resources::get_string("Prefs.general_tab"),
      new BooleanConfigurer(
        USE_KEYBOARD,
        Resources::get_string("CounterDetailViewer.use_prompt", keyDesc),
        Boolean.FALSE
      )
    );
    ...
    GameModule.getGameModule().getPrefs().addOption(
      ...
      new IntConfigurer(
        PREFERRED_DELAY,
        Resources::get_string("CounterDetailViewer.delay_prompt"),
        delay
      )
    );
  ...
  protected void drawText(Graphics g, @SuppressWarnings("unused") Point pt, @SuppressWarnings("unused") JComponent comp, @SuppressWarnings("unused")List<GamePiece> pieces) {
    ...
    final String offboard = Resources::get_string("Map.offboard");  //$NON-NLS-1$
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
      Resources::get_string("Editor.MouseOverStackViewer.version"), //$NON-NLS-1$ not displayed
      Resources::get_string("Editor.description_label"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.recommend_delay"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.keyboard_shortcut"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.bg_color"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.text_color"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.display_pieces"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.display_zoom"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.center_all"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.draw_pieces"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.draw_zoom"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.display_graphics_obselete"), //$NON-NLS-1$ Obsolete
      Resources::get_string("Editor.MouseOverStackViewer.piece_gap"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.vertical_offset"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.display_text"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.enable_html"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.center_text"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.stretch_width_summary"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.combine_counter_summary"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.extra_text_padding"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.vertical_top_text"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.display_text_obsolete"), //$NON-NLS-1$ Obsolete
      Resources::get_string("Editor.font_size"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.summary_text"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.text_below"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.text_empty"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.include_pieces"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.listed_layers"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.piece_filter"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.non_stacking"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.move_selected"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.non_moveable"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.unrotated_state"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.show_deck"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.show_deck_masked"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.show_deck_depth"), //$NON-NLS-1$
      Resources::get_string("Editor.MouseOverStackViewer.show_overlap"), //$NON-NLS-1$
    };
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.MouseOverStackViewer.component_type"); //$NON-NLS-1$
  }
