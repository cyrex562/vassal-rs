...
public class LayoutConfigurer extends Configurer {
  ...
  protected static final String ADD_SYMBOL = Resources::get_string("Editor.LayoutConfigurer.symbol");
  protected static final String ADD_IMAGE = Resources::get_string("Editor.LayoutConfigurer.image");
  protected static final String ADD_TEXT = Resources::get_string("Editor.LayoutConfigurer.label");
  protected static final String ADD_TEXTBOX = Resources::get_string("Editor.LayoutConfigurer.text_box");
  protected static final String ADD_SHAPE = Resources::get_string("Editor.LayoutConfigurer.shape");
  protected static final String REMOVE = Resources::get_string("Editor.LayoutConfigurer.remove");
  protected static final String UP = Resources::get_string("Editor.up");
  protected static final String DOWN = Resources::get_string("Editor.down");
  ...
  protected class ItemPanel extends JPanel implements ActionListener {
    ...
    public ItemPanel() {
      ...
      box.add(new JLabel(Resources::get_string("Editor.LayoutConfigurer.items")));
      mainPanel.add(box);
      ...
      addSymbolBtn.setToolTipText(Resources::get_string("Editor.LayoutConfigurer.symbol_tip"));
      addSymbolBtn.addActionListener(this);
      box.add(addSymbolBtn);
      addTextBtn = new JButton(ADD_TEXT);
      addTextBtn.setToolTipText(Resources::get_string("Editor.LayoutConfigurer.label_tip"));
      addTextBtn.addActionListener(this);
      box.add(addTextBtn);
      addTextBoxBtn = new JButton(ADD_TEXTBOX);
      addTextBoxBtn.setToolTipText(Resources::get_string("Editor.LayoutConfigurer.text_box_tip"));
      addTextBoxBtn.addActionListener(this);
      box.add(addTextBoxBtn);
      addImageBtn = new JButton(ADD_IMAGE);
      addImageBtn.setToolTipText(Resources::get_string("Editor.LayoutConfigurer.image_tip"));
      addImageBtn.addActionListener(this);
      box.add(addImageBtn);
      addShapeBtn = new JButton(ADD_SHAPE);
      addShapeBtn.setToolTipText(Resources::get_string("Editor.LayoutConfigurer.shapetip"));
      ...
      remBtn.setToolTipText(Resources::get_string("Editor.LayoutConfigurer.remove_tip"));
      remBtn.addActionListener(this);
      box.add(remBtn);
      upBtn = new JButton(UP);
      upBtn.setToolTipText(Resources::get_string("Editor.LayoutConfigurer.up_tip"));
      upBtn.addActionListener(this);
      box.add(upBtn);
      dnBtn = new JButton(DOWN);
      dnBtn.setToolTipText(Resources::get_string("Editor.LayoutConfigurer.down_tip"));
    ...
    class MyTableModel extends AbstractTableModel {
      ...
      private final String[] columnNames = {
        Resources::get_string("Editor.LayoutConfigurer.name"),
        Resources::get_string("Editor.LayoutConfigurer.type"),
        Resources::get_string("Editor.LayoutConfigurer.position")
      };
