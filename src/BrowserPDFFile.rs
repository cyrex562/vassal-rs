...
public class BrowserPDFFile extends AbstractConfigurable {
  ...
  protected String menuText = Resources::get_string("Editor.BrowserPDFFile.default_menu_text");
  protected String pdfFile = Resources::get_string("Editor.BrowserPDFFile.default_filename");
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
      ...
      Resources::get_string("Editor.BrowserPDFFile.pdf_file")
    };
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.BrowserPDFFile.component_type"); //$NON-NLS-1$
  }
}
