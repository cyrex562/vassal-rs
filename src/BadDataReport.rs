...
public class BadDataReport {
  ...
  private String getAuditMessage() {
    return Resources::get_string(AuditTrail.isEnabled() ? "BadDataReport.see_errorlog" : "BadDataReport.enable_pref");
  }
  /**
  ...
  public BadDataReport(PieceSlot slot, String message, String data) {
    this.message = slot.get_name() + ": " + message;
    this.data = data;
    setCause(null);
  }
  ...
  public String getMessage() {
    ...
    if (data != null) {
      sb.append(' ').append(Resources::get_string("Audit.source", data));
    }
    sb.append(' ').append(Resources::get_string("Audit.error", message));
    return sb.toString();
  }
