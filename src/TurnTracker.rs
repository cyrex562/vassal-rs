...
public class TurnTracker extends TurnComponent implements CommandEncoder, GameComponent, ActionListener, UniqueIdManager.Identifyable, RecursionLimiter.Loopable, ComponentDescription {
  ...
  protected FormattedString reportFormat = new FormattedString(Resources::get_string("Editor.TurnTracker.report_default"));
  ...
  public TurnTracker() {
    ...
    setConfigureName(Resources::get_string("TurnTracker.turn")); //$NON-NLS-1$
    launch = new LaunchButton(Resources::get_string("TurnTracker.turn"), "", BUTTON_TEXT, HOT_KEY, ICON, al); //$NON-NLS-1$
    launch.setToolTipText(Resources::get_string("TurnTracker.turn_tracker")); //$NON-NLS-1$

    SET_COMMAND = Resources::get_string("TurnTracker.set_turn"); //$NON-NLS-1$
    DOCK_COMMAND = Resources::get_string("General.dock"); //$NON-NLS-1$
    UNDOCK_COMMAND = Resources::get_string("General.undock"); //$NON-NLS-1$
    ...
    // Create preferences
    final IntConfigurer size = new IntConfigurer(FONT_SIZE, Resources::get_string("TurnTracker.size_pref"), sizeDefault); //$NON-NLS-1$
    final BooleanConfigurer bold = new BooleanConfigurer(FONT_BOLD,  Resources::get_string("TurnTracker.bold_pref"), boldDefault); //$NON-NLS-1$
    final BooleanConfigurer docked = new BooleanConfigurer(DOCKED,  Resources::get_string("TurnTracker.docked_pref"), dockedDefault); //$NON-NLS-1$

    final String prefTab = Resources::get_string("TurnTracker.turn_counter"); //$NON-NLS-1$
  ...
  public String getAttributeValueString(String key) {
    if (NAME.equals(key)) {
      ...
      return NamedHotKeyConfigurer.encode(nextListener.get_namedKeyStroke());
    }
    else if (PREV_HOT_KEY.equals(key)) {
      return NamedHotKeyConfigurer.encode(prevListener.get_namedKeyStroke());
    }
    else if (PLUS_BUTTON_WIDTH.equals(key)) {
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
      Resources::get_string("Editor.name_label"),
      Resources::get_string(Resources.DESCRIPTION),
      Resources::get_string("Editor.button_text_label"),
      Resources::get_string("Editor.button_icon_label"),
      Resources::get_string("Editor.TurnTracker.show_hotkey"),
      Resources::get_string("Editor.TurnTracker.next_hotkey"),
      Resources::get_string("Editor.TurnTracker.prev_hotkey"),
      Resources::get_string("Editor.TurnTracker.turn_name_format"),
      Resources::get_string("Editor.report_format"),
      Resources::get_string("Editor.TurnTracker.turn_tooltip"),
      Resources::get_string("Editor.TurnTracker.turn_length"),
      Resources::get_string("Editor.TurnTracker.turn_display"),
      Resources::get_string("Editor.TurnTracker.plus_button_width"),
      Resources::get_string("Editor.TurnTracker.turn_button_height"),
      Resources::get_string("Editor.TurnTracker.forward_only") // FWD_ONLY
    };
  }
  ...
  public static class LengthStyleConfig extends TranslatableStringEnum {
    ...
    public String[] getI18nKeys(AutoConfigurable target) {
      return new String[]{
        Resources::get_string("Editor.TurnTracker.length_variable"),
        Resources::get_string("Editor.TurnTracker.length_fixed"),
        Resources::get_string("Editor.TurnTracker.length_maximum"),
      };
    }
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.TurnTracker.component_type");
  }
  ...
  protected void doGlobalkeys() {
    for (final TurnGlobalHotkey key : get_components_of(TurnGlobalHotkey.class)) {
      try {
  ...
  protected void set() {
    ...
    if (setDialog == null) {
      ...
      setDialog.setTitle(Resources::get_string("TurnTracker.set_turn2", getConfigureName())); //$NON-NLS-1$
    }
  ...
  protected class TurnWidget extends JPanel implements MouseListener {
    ...
    public void setWidth(int length) {
      ...
      if (!initialized) {
        ...
        setNextStroke(nextListener.get_namedKeyStroke());
        ...
        setPrevStroke(prevListener.get_namedKeyStroke());
    ...
    public void setNextStroke(NamedKeyStroke key) {
      final String tooltip = Resources::get_string("TurnTracker.next_turn") + (key == null ? "" : " " + NamedHotKeyConfigurer.getFancyString(key)); //NON-NLS
      if (nextButton != null) {
    ...
    public void setPrevStroke(NamedKeyStroke key) {
      final String tooltip = Resources::get_string("TurnTracker.prev_turn") +  //$NON-NLS-1$
  ...
  protected void buildPopup() {
    ...
    final JMenu config = new JMenu(Resources::get_string("TurnTracker.configure")); //$NON-NLS-1$
  ...
  protected class SetDialog extends JDialog {
    ...
    protected void initComponents() {
      ...
      final JButton saveButton = new JButton(Resources::get_string(Resources.SAVE));
      saveButton.setToolTipText(Resources::get_string("TurnTracker.save_changes")); //$NON-NLS-1$
      p.add(saveButton);
      ...
      final JButton cancelButton = new JButton(Resources::get_string(Resources.CANCEL));
      cancelButton.setToolTipText(Resources::get_string("TurnTracker.discard_changes")); //$NON-NLS-1$
    ...
    public void setControls(TurnTracker turn) {
      ...
      if (getTurnLevelCount() > 1) {
        ...
        final StringEnumConfigurer e = new StringEnumConfigurer(null, Resources::get_string("TurnTracker.select"), s); //$NON-NLS-1$
