...
public class MultiActionButton extends ToolbarMenu implements Loopable {
  ...
  public MultiActionButton() {
    super();
    setAttribute(AbstractToolbarItem.BUTTON_TEXT, Resources::get_string("Editor.MultiActionButton.component_type")); //$NON-NLS-1$
    setAttribute(AbstractToolbarItem.TOOLTIP, Resources::get_string("Editor.MultiActionButton.component_type")); //$NON-NLS-1$
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.addAll(super.getAttributeDescriptions(),
        Resources::get_string("Editor.MultiActionButton.buttons") //$NON-NLS-1$
    );
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.MultiActionButton.component_type"); //$NON-NLS-1$
  }
