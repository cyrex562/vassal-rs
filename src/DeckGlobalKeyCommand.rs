...
public class DeckGlobalKeyCommand extends MassKeyCommand {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.DeckGlobalKeyCommand.component_type"); //$NON-NLS-1$
  }
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      Resources::get_string(Resources.MENU_COMMAND_LABEL),
      Resources::get_string("Editor.GlobalKeyCommand.global_key_command"), //$NON-NLS-1$

      Resources::get_string("Editor.GlobalKeyCommand.pre_select"), // Fast Match parameters (not displayed)

      Resources::get_string("Editor.DeckGlobalKeyCommand.matching_properties"), //$NON-NLS-1$
      Resources::get_string("Editor.DeckGlobalKeyCommand.affects"), //$NON-NLS-1$
      Resources::get_string("Editor.report_format"), //$NON-NLS-1$
      Resources::get_string("Editor.MassKey.suppress"),
    };
  }
