...
public class Obscurable extends Decorator implements TranslatablePiece {
  ...
  protected static final String DEFAULT_PEEK_COMMAND = Resources::get_string("Editor.Obscurable.default_peek_command");
  ...
  protected String hideCommand = Resources::get_string("Editor.Obscurable.default_mask_command");
...
//    }
  ...
  public String getLocalizedName() {
    ...
    return get_name(maskedName, true);
  }

  @Override
  public String get_name() {
    final String maskedName = maskName == null ? "?" : maskName;
    return get_name(maskedName, false);
  }

  protected String get_name(String maskedName, boolean localized) {
    if (obscuredToMe()) {
      return maskedName;
    }
    else if (obscuredToOthers()) {
      return (localized ? piece.getLocalizedName() : piece.get_name()) + "(" + maskedName + ")";
    }
    else {
      return (localized ? piece.getLocalizedName() : piece.get_name());
    }
  }
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.Obscurable.trait_description");
  }
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(new String[] {hideCommand, maskName, peekCommand},
      new String[] {
        Resources::get_string("Editor.Obscurable.mask_command"),
        Resources::get_string("Editor.Obscurable.name_when_masked"),
        Resources::get_string("Editor.Obscurable.peek_command")});
  }
  ...
  private static class Ed implements PieceEditor {
    ...
    public Ed(Obscurable p) {
      ...
      final JLabel displayLabel = new JLabel(Resources::get_string("Editor.Obscurable.display_style"));
      ...
      peekKeyLabel = new JLabel(Resources::get_string("Editor.Obscurable.peek_keyboard_command"));
      ...
      peekCommandLabel = new JLabel(Resources::get_string("Editor.Obscurable.peek_menu_command"));
