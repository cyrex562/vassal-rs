...
public abstract class GridEditor extends JDialog implements MouseListener, KeyListener {
  ...
  protected static final String SET = Resources::get_string("Editor.GridEditor.set_grid_shape"); //$NON-NLS-1$
  protected static final String CANCEL = Resources::get_string(Resources.CANCEL);
  protected static final String CANCEL_SET = Resources::get_string("Editor.GridEditor.cancel_set"); //$NON-NLS-1$
  protected static final String OK = Resources::get_string(Resources.SAVE);
  protected static final String NUMBERING = Resources::get_string("Editor.GridEditor.numbering"); //$NON-NLS-1$
  ...
  public GridEditor(EditableGrid grid) {
    ...
    setTitle(Resources::get_string("Editor.ModuleEditor.edit", grid.getGridName())); //$NON-NLS-1$
    setModal(true);
    this.grid = grid;
  ...
  protected void initComponents() {
    ...
    textPanel.add(new JLabel(Resources::get_string("Editor.GridEditor.arrow_keys"))); //$NON-NLS-1$
    textPanel.add(new JLabel(SystemUtils.IS_OS_MAC ? Resources::get_string("Editor.GridEditor.command_arrow_keys") : Resources::get_string("Editor.GridEditor.control_arrow_keys"))); //$NON-NLS-1$
    textPanel.add(new JLabel(Resources::get_string("Editor.GridEditor.shift_key"))); //$NON-NLS-1$
...
*/
  ...
  protected void startSetMode() {
    ...
    JOptionPane.showMessageDialog(view,
        Resources::get_string("Editor.GridEditor.click_on_3")); //$NON-NLS-1$
    repaint();
  }
  ...
  protected void reportShapeError() {
    JOptionPane.showMessageDialog(view,
        Resources::get_string("Editor.GridEditor.does_not_look", grid.getGridName()), //$NON-NLS-1$
        Resources::get_string("Editor.GridEditor.grid_shape_error"), //$NON-NLS-1$
