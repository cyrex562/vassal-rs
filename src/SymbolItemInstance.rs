...
public class SymbolItemInstance extends ItemInstance {
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
      Resources::get_string("Editor.SymbolItemInstance.unit_size"),
      Resources::get_string("Editor.SymbolItemInstance.first_symbol"),
      Resources::get_string("Editor.SymbolItemInstance.second_symbol"),
      Resources::get_string("Editor.SymbolItemInstance.symbol_color"),
      Resources::get_string("Editor.background_color"),
      Resources::get_string("Editor.SymbolItemInstance.size_color")
    };
  }
