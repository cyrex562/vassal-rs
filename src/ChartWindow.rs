...
public class ChartWindow extends Widget {
  ...
  public ChartWindow() {
    ...
    setAttribute(NAME, Resources::get_string("Editor.ChartWindow.component_type"));
    setAttribute(BUTTON_TEXT, Resources::get_string("Editor.ChartWindow.component_type"));
    launch.setAttribute(TOOLTIP, Resources::get_string("Editor.ChartWindow.component_type"));
  }
  ...
  public void addTo(Buildable b) {
    ...
    final int count = GameModule.getGameModule().get_components_of(ChartWindow.class).size();
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.ChartWindow.component_type"); //$NON-NLS-1$
  }
