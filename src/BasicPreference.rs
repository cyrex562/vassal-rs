...
public abstract class BasicPreference extends AbstractConfigurable {
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {"", Resources::get_string("Editor.BasicPreference.tab"), Resources::get_string("Editor.BasicPreference.desc"), Resources::get_string("Editor.BasicPreference.global"), Resources::get_string("Editor.BasicPreference.default")};
  }
    ...
    public Configurer getConfigurer(AutoConfigurable c, String key, String name) {
      return new Configurer(null, "note") { //NON-NLS
        ...
        public Component getControls() {
          return new JLabel(Resources::get_string("Editor.BasicPreference.note"));
        }
      };
    }
