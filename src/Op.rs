    ...
    for (Throwable c = e; c != null; c = c.getCause()) {
      if (c instanceof OpFailedException) {
        ...
        ErrorDialog.tileWarning(new BadDataReport(
          ...
          ((TileNotFoundException) c).getFile().get_name(),
          null
        ));
      }
        ...
        ErrorDialog.dataWarning(new BadDataReport(
          ...
          ((ImageNotFoundException) c).getFile().get_name(),
          null
        ));
        return true;
      }
        ...
        ErrorDialog.dataWarning(new BadDataReport(
          ...
          ((UnrecognizedImageTypeException) c).getFile().get_name(),
          c
        ));
        return true;
      }
        ...
        ErrorDialog.dataWarning(new BadDataReport(
          ...
          ((ImageIOException) c).getFile().get_name(),
          c
        ));
        return true;
      }
