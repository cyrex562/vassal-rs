...
public class Chatter extends JPanel implements CommandEncoder, Buildable, DropTargetListener {
  ...
  public static String getAnonymousUserName() {
    return Resources::get_string("Chat.anonymous"); //$NON-NLS-1$
  }
  ...
  public Chatter() {
    ...
    copyAction.putValue(Action.NAME, Resources::get_string("General.copy"));
    ...
    cutAction.putValue(Action.NAME, Resources::get_string("General.cut"));

    final Action pasteAction = new DefaultEditorKit.PasteAction();
    pasteAction.putValue(Action.NAME, Resources::get_string("General.paste"));
  ...
  private void doShow(String s) {
    ...
    final String keystring = Resources::get_string("PlayerRoster.observer");
  ...
  public void addTo(Buildable b) {
    ...
    final FontConfigurer chatFont = new FontConfigurer("ChatFont", //NON-NLS
      Resources::get_string("Chatter.chat_font_preference"));
    ...
    chatFont.fireUpdate();
    mod.getPrefs().addOption(Resources::get_string("Chatter.chat_window"), chatFont); //$NON-NLS-1$
    ...
    final ColorConfigurer gameMsgColor = new ColorConfigurer(GAME_MSG1_COLOR,
      Resources::get_string("Chatter.game_messages_preference"), Color.black);
    ...
    globalPrefs.addOption(Resources::get_string("Chatter.chat_window"), gameMsgColor);
    ...
    final ColorConfigurer gameMsg2Color = new ColorConfigurer(GAME_MSG2_COLOR,
      Resources::get_string("Chatter.game_messages_preference_2"), new Color(0, 153, 51));
    ...
    globalPrefs.addOption(Resources::get_string("Chatter.chat_window"), gameMsg2Color);
    ...
    final ColorConfigurer gameMsg3Color = new ColorConfigurer(GAME_MSG3_COLOR,
      Resources::get_string("Chatter.game_messages_preference_3"), new Color(255, 102, 102));
    ...
    globalPrefs.addOption(Resources::get_string("Chatter.chat_window"), gameMsg3Color);
    ...
    final ColorConfigurer gameMsg4Color = new ColorConfigurer(GAME_MSG4_COLOR,
      Resources::get_string("Chatter.game_messages_preference_4"), new Color(255, 0, 0));
    ...
    globalPrefs.addOption(Resources::get_string("Chatter.chat_window"), gameMsg4Color);
    ...
    final ColorConfigurer gameMsg5Color = new ColorConfigurer(GAME_MSG5_COLOR,
      Resources::get_string("Chatter.game_messages_preference_5"), new Color(153, 0, 153));
    ...
    globalPrefs.addOption(Resources::get_string("Chatter.chat_window"), gameMsg5Color);
    ...
    final ColorConfigurer systemMsgColor = new ColorConfigurer(SYS_MSG_COLOR,
      Resources::get_string("Chatter.system_message_preference"), new Color(160, 160, 160));
    ...
    globalPrefs.addOption(Resources::get_string("Chatter.chat_window"), systemMsgColor);
    ...
    final ColorConfigurer myChatColor = new ColorConfigurer(
      MY_CHAT_COLOR,
      Resources::get_string("Chatter.my_text_preference"),
      new Color(9, 32, 229));
    ...
    globalPrefs.addOption(Resources::get_string("Chatter.chat_window"), myChatColor);

    myChat = (Color) globalPrefs.getValue(MY_CHAT_COLOR);

    final ColorConfigurer otherChatColor = new ColorConfigurer(
      OTHER_CHAT_COLOR,
      Resources::get_string("Chatter.other_text_preference"),
      new Color(0, 153, 255)
    );
    ...
    globalPrefs.addOption(Resources::get_string("Chatter.chat_window"), otherChatColor);
  ...
  public static class DisplayText extends Command {
    ...
    public Command myUndoCommand() {
      return new DisplayText(c, Resources::get_string("Chatter.undo_message", msg)); //$NON-NLS-1$
    }
