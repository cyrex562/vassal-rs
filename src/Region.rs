...
public class Region extends AbstractConfigurable {
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      ...
      Resources::get_string("Editor.Region.x_coord"), //$NON-NLS-1$
      Resources::get_string("Editor.Region.y_coord"), //$NON-NLS-1$
    };
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.Region.component_type"); //$NON-NLS-1$
  }
