...
public class MapShader extends AbstractToolbarItem implements GameComponent, Drawable, UniqueIdManager.Identifyable {
  ...
  public MapShader() {
    ...
    setLaunchButton(makeLaunchButton(
      "",
      Resources::get_string("Editor.MapShader.shade"),
      "",
      e -> toggleShading()
    ));
    ...
    setConfigureName(Resources::get_string("Editor.MapShader.configure_name"));
    reset();
  }
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      ...
      Resources::get_string("Editor.MapShader.shading_on"), //$NON-NLS-1$
      Resources::get_string("Editor.MapShader.shading_start"), //$NON-NLS-1$
      ...
      Resources::get_string(Resources.HOTKEY_LABEL),
      Resources::get_string("Editor.MapShader.shade_boards"), //$NON-NLS-1$
      Resources::get_string("Editor.MapShader.board_list"), //$NON-NLS-1$
      Resources::get_string("Editor.MapShader.type"), //$NON-NLS-1$
      Resources::get_string("Editor.MapShader.shade_top"), //$NON-NLS-1$
      Resources::get_string("Editor.MapShader.pattern"), //$NON-NLS-1$
      Resources::get_string(Resources.COLOR_LABEL),
      Resources::get_string("Editor.image_label"), //$NON-NLS-1$
      Resources::get_string("Editor.MapShader.scale"), //$NON-NLS-1$
      Resources::get_string("Editor.MapShader.opacity"), //$NON-NLS-1$
      Resources::get_string("Editor.MapShader.border"), //$NON-NLS-1$
      Resources::get_string("Editor.border_color"), //$NON-NLS-1$
      Resources::get_string("Editor.MapShader.border_width"), //$NON-NLS-1$
      Resources::get_string("Editor.MapShader.border_opacity"), //$NON-NLS-1$
    };
  }
  ...
  protected void buildBoardClip() {
    if (boardClip == null) {
      ...
      for (final Board b : map.getBoards()) {
        final String boardName = b.get_name();
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.MapShader.component_type"); //$NON-NLS-1$
  }
