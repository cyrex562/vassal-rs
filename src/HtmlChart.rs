...
public class HtmlChart extends Widget implements MouseListener {
  ...
  private String getFile(final String fname) {
    ...
    try (InputStream inner = mda.getInputStream(localizedFileName);
      ...
      ErrorDialog.dataWarning(new BadDataReport(this, Resources::get_string("Error.not_found", "Chart"), fname, e)); //NON-NLS
    }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.HTMLChart.component_type");
  }
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{Resources::get_string("Editor.name_label"), Resources::get_string(Resources.DESCRIPTION), Resources::get_string("Editor.HTMLChart.html_file")};
  }
  ...
  protected void maybePopup(MouseEvent event) {
    if (event.isPopupTrigger()) {
      ...
      final JMenuItem item = new JMenuItem(Resources::get_string("Editor.HTMLChart.return_to_default_page"));
  ...
  public static class XTMLEditorKit extends HTMLEditorKit {
    ...
    public static class XTMLFactory extends HTMLFactory implements ViewFactory {
      ...
      public View create(Element element) {
        ...
        if (kind != null && element.get_name().equals("img")) {  //NON-NLS
