...
// FIXME: these should go into a cache, like images have
  ...
  public String get_name() {
    return archive == null ? "data archive" : archive.get_name(); //NON-NLS
  }
  ...
  public InputStream getInputStream(String fileName)
    ...
    throw new FileNotFoundException(
      "'" + fileName + "' not found in " + get_name()
    );
  }
  ...
  public URL getURL() throws IOException {
    ...
    return URLUtils.toJarURL(archive.get_name());
  }
  ...
  protected Class<?> findClass(String name) throws ClassNotFoundException {
    ...
    if (major > 55 || (major == 55 && minor != 0)) {
      ProblemDialog.showDisableable(
        ...
        null,
        cs,
        Resources::get_string("Dialogs.incompatible.title"),
        Resources::get_string("Dialogs.incompatible.heading"),
        Resources::get_string("Dialogs.incompatible.message", name) + "\n\n"
