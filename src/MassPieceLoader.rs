...
public class MassPieceLoader {
  ...
  class MassLoaderDialog extends JDialog {
    ...
    public MassLoaderDialog() {
      ...
      setModal(true);
      setTitle(Resources::get_string("Editor.MassPieceLoader.load_multiple"));
      ...
      add(new JLabel(Resources::get_string("Editor.MassPieceLoader.image_directory")));
      ...
      add(new JLabel(Resources::get_string("Editor.MassPieceLoader.no_basic_piece")));
      ...
      add(new JLabel(Resources::get_string("Editor.MassPieceLoader.no_empty_level")));
      add(emptyLevelConfig.getControls());

      defineDialog = new DefineDialog(this);
      final JButton defineButton = new JButton(Resources::get_string("Editor.MassPieceLoader.edit_piece_template"));
    ...
    public void save() {
      ...
      if (pieceCount > 0) {
        final String message = Resources::get_string("Editor.MassPieceLoader.this_will_load", pieceCount, target.getConfigureName());
        final int result = Dialogs.showConfirmDialog(null, Resources::get_string("Editor.MassPieceLoader.confirm_load"),
          Resources::get_string("Editor.MassPieceLoader.confirm_load"), message, JOptionPane.WARNING_MESSAGE,
      ...
      if (dir != null && dir.isDirectory()) {
        ...
        if (files != null) {
          ...
          for (final File file : files) {
            final String imageName = file.get_name();
    ...
    public void load(PieceNode pieceNode) {
      ...
      final String basicType =
        new SequenceEncoder("", ';')
          ...
          .append(pieceNode.get_name()).getValue();
  ...
  private static class DefineDialog extends JDialog {
    ...
    public DefineDialog(JDialog owner) {
      ...
      setModal(true);
      setVisible(false);
      setTitle(Resources::get_string("Editor.MassPieceLoader.multiple_piece_template"));
      ...
      final JButton canButton = new JButton(Resources::get_string(Resources.CANCEL));
  ...
  private class MyTreeTableModel extends DefaultTreeTableModel {
    ...
    public String getColumnName(int col) {
      switch (col) {
      case DESC_COL:
        return Resources::get_string("Editor.MassPieceLoader.item");
      case NAME_COL:
        return Resources::get_string("Editor.MassPieceLoader.piece_name");
      case IMAGE_COL:
        return Resources::get_string("Editor.MassPieceLoader.image_name");
      case SKIP_COL:
        return Resources::get_string("Editor.MassPieceLoader.skip");
      case COPIES_COL:
        return Resources::get_string("Editor.MassPieceLoader.copies");
      }
      return "";
    }
  ...
  private static class BasicNode extends DefaultMutableTreeTableNode {
    ...
    public String getDescription() {
      return Resources::get_string("Editor.MassPieceLoader.root");
    }
  ...
  private class PieceNode extends BasicNode {
    ...
    @Override
    public String getDescription() {
      return Resources::get_string("Editor.MassPieceLoader.piece_desc");
    }
    ...
    public void setSkip(boolean skip) {
      super.setSkip(skip);
      pieceInfo.put(getImageName(), new PieceInfo(get_name(), skip));
    }
  }
  ...
  private static class LayerNode extends BasicNode {
    ...
    @Override
    public String getDescription() {
      return Resources::get_string("Editor.MassPieceLoader.layer_desc") + (name.length() > 0 ? " [" + name + "]" : "");
    }
  ...
  private static class LevelNode extends BasicNode {
    ...
    @Override
    public String getDescription() {
      return Resources::get_string("Editor.MassPieceLoader.level") + " " + (levelNumber + 1)
          + (name.length() > 0 ? " [" + name + "]" : "");
    }
  ...
  private static class Emb extends Embellishment {
    ...
    @Override
    public String getDescription() {
      return Resources::get_string("Editor.MassPieceLoader.embellishment_trait_description") +
        super.getDescription().substring(Resources::get_string("Editor.Embellishment.trait_description").length());
    }
  ...
  private static class LoaderImagePicker extends MultiImagePicker {
    ...
    public void addEntry() {
      final String entry = Resources::get_string("Editor.MassPieceLoader.image") + " " + (imageListElements.size() + 1);
  ...
  private static class Entry extends JPanel {
    ...
    private final JLabel warning = new JLabel(Resources::get_string("Editor.MassPieceLoader.warning_suffix"));

    public Entry() {
      setLayout(new BoxLayout(this, BoxLayout.Y_AXIS));
      add(new JLabel(
        Resources::get_string("Editor.MassPieceLoader.do_not_suffix")));

      final JPanel entry = new JPanel(new MigLayout("ins 0,hidemode 3", "[]rel[]")); // NON-NLS
      entry.add(new JLabel(Resources::get_string("Editor.MassPieceLoader.image_name") + " "));
