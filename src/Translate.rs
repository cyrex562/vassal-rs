...
public class Translate extends Decorator implements TranslatablePiece {
  ...
  public Translate() {
    this(ID + Resources::get_string("Editor.MoveFixedDistance.default_command"), null);
  }
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.MoveFixedDistance.trait_description");
  }
  ...
  public void mySetType(String type) {
    ...
    commandName = st.nextToken(Resources::get_string("Editor.MoveFixedDistance.default_command"));
  ...
  protected void translate(Point p) {
    ...
    final int Xdist = xDist.getTextAsInt(outer, Resources::get_string("Editor.MoveFixedDistance.distance_to_the_right"), this); // NON-NLS
    final int Xindex = xIndex.getTextAsInt(outer, Resources::get_string("Editor.MoveFixedDistance.additional_offset_to_the_right"), this); // NON-NLS
    final int Xoffset = xOffset.getTextAsInt(outer, Resources::get_string("Editor.MoveFixedDistance.times") + " X", this); // NON-NLS
    ...
    final int Ydist = yDist.getTextAsInt(outer, Resources::get_string("Editor.MoveFixedDistance.distance_upwards"), this); // NON-NLS
    final int Yindex = yIndex.getTextAsInt(outer, Resources::get_string("Editor.MoveFixedDistance.additional_offset_upwards"), this); // NON-NLS
    final int Yoffset = yOffset.getTextAsInt(outer, Resources::get_string("Editor.MoveFixedDistance.times") + " Y", this); // NON-NLS
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(commandName, getCommandDescription(description, Resources::get_string("Editor.MoveFixedDistance.move_fixed_distance_command")));
  }
  ...
  public static class Editor implements PieceEditor {
    ...
    public Editor(Translate t) {
      ...
      final JLabel xLabel = new JLabel(Resources::get_string("Editor.MoveFixedDistance.additional_offset_to_the_right"));
      ...
      JLabel times = new JLabel(Resources::get_string("Editor.MoveFixedDistance.times"));
      ...
      final JLabel yLabel = new JLabel(Resources::get_string("Editor.MoveFixedDistance.additional_offset_upwards"));
      ...
      times = new JLabel(Resources::get_string("Editor.MoveFixedDistance.times"));
