...
public class TextItemInstance extends ItemInstance {
  ...
  public String[] getAttributeDescriptions() {
    return new String[] {
      Resources::get_string("Editor.TextItemInstance.value"),
      Resources::get_string("Editor.foreground_color"),
      Resources::get_string("Editor.background_color"),
      Resources::get_string("Editor.TextItemInstance.outline_color")
    };
  }
