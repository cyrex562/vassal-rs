...
public class Labeler extends Decorator implements TranslatablePiece, Loopable {
  ...
  private String menuCommand = Resources::get_string("Editor.TextLabel.change_label");
  ...
  public void mySetType(String type) {
    ...
    menuCommand = st.nextToken(Resources::get_string("Editor.TextLabel.change_label"));
  ...
  public String get_name() {
    ...
    if ((label.length() == 0) && !alwaysUseFormat) {
      result =  piece.get_name();
    }
    else {
      nameFormat.setProperty(PIECE_NAME, piece.get_name());
      //
      // Bug 9483
  ...
  public void setLabel(String s) {
    ...
    labelFormat.setProperty(BasicPiece.PIECE_NAME, piece.get_name());
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.TextLabel.trait_description");
  }
  ...
  private static class Ed implements PieceEditor {
    ...
    public Ed(Labeler l) {
      ...
      p.add(new JLabel(Resources::get_string("Editor.size_label")));
      fontSize = new IntConfigurer(l.font.getSize());
      p.add(fontSize.getControls());
      p.add(new JLabel(Resources::get_string("Editor.TextLabel.bold")));
      ...
      p.add(new JLabel(Resources::get_string("Editor.TextLabel.italic")));
      ...
      p.add(new JLabel(Resources::get_string("Editor.TextLabel.offset")));
  ...
  public PieceI18nData getI18nData() {
    return getI18nData(
        ...
        new String[] {
          Resources::get_string("Editor.TextLabel.label_text"),
          Resources::get_string("Editor.TextLabel.name_format"),
          Resources::get_string("Editor.TextLabel.change_label_command")
        });
  }
