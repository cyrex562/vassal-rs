...
public class DeckSendKeyCommand extends AbstractDeckKeyCommand {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.DeckSendKeyCommand.component_type"); //$NON-NLS-1$
  }
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.addAll(
      ...
      Resources::get_string("Editor.DeckSendKeyCommand.variable_deck"),
      Resources::get_string("Editor.DeckSendKeyCommand.deck_name"),
      Resources::get_string("Editor.DeckSendKeyCommand.deck_expression"),
      Resources::get_string("Editor.DeckSendKeyCommand.send_matching"),
      Resources::get_string("Editor.DeckSendKeyCommand.send_expression"),
      Resources::get_string("Editor.DeckSendKeyCommand.limit"),
      Resources::get_string("Editor.DeckSendKeyCommand.limit_expression"),
      Resources::get_string("Editor.DeckSendKeyCommand.stop"),
      Resources::get_string("Editor.DeckSendKeyCommand.stop_expression"),
      Resources::get_string("Editor.DeckSendKeyCommand.stop_include"),
      Resources::get_string("Editor.DeckSendKeyCommand.order")
    );
  }
