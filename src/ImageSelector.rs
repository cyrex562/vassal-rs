...
public class ImageSelector extends Configurer implements ItemListener {
  ...
  private static final String NO_IMAGE = "(" + Resources::get_string("Editor.ImagePicker.no_image") + ")";
  ...
  private void initControls() {
    ...
    final JButton addButton = new JButton(Resources::get_string("Editor.imageSelector.add_image"));
    addButton.addActionListener(e -> pickImage());
    final JButton clearButton = new JButton(Resources::get_string("Editor.imageSelector.clear_image"));
  ...
  private void pickImage() {
    ...
    if (fc.showOpenDialog(gm.getPlayerWindow()) == FileChooser.APPROVE_OPTION && fc.getSelectedFile().exists()) {
      final String name = fc.getSelectedFile().get_name();
