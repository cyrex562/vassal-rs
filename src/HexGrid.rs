...
public class HexGrid extends AbstractConfigurable
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      Resources::get_string("Editor.HexGrid.sideways"), //$NON-NLS-1$
      Resources::get_string("Editor.x_offset"), //$NON-NLS-1$
      Resources::get_string("Editor.y_offset"), //$NON-NLS-1$
      Resources::get_string("Editor.HexGrid.hex_height"), //$NON-NLS-1$
      Resources::get_string("Editor.HexGrid.hex_width"), //$NON-NLS-1$
      Resources::get_string("Editor.Grid.snap"), //$NON-NLS-1$
      Resources::get_string("Editor.Grid.edges"), //$NON-NLS-1$
      Resources::get_string("Editor.HexGrid.vertices"), //$NON-NLS-1$
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.HexGrid.component_type"); //$NON-NLS-1$
  }
