...
public class DoActionButton extends AbstractToolbarItem
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.DoAction.component_type"); //$NON-NLS-1$
  }
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.addAll(super.getAttributeDescriptions(),
      Resources::get_string("Editor.DoAction.display_message"), //$NON-NLS-1$
      Resources::get_string("Editor.report_format"), //$NON-NLS-1$
      Resources::get_string("Editor.DoAction.play_sound"), //$NON-NLS-1$
      Resources::get_string("Editor.DoAction.sound_clip"), //$NON-NLS-1$
      Resources::get_string("Editor.DoAction.send_hotkeys"), //$NON-NLS-1$
      Resources::get_string("Editor.DoAction.hotkeys"), //$NON-NLS-1$
      Resources::get_string("Editor.DoAction.repeat_actions"), //$NON-NLS-1$
      Resources::get_string("Editor.LoopControl.type_of_loop"), //$NON-NLS-1$
      Resources::get_string("Editor.LoopControl.loop_how_many"), //$NON-NLS-1$
      Resources::get_string("Editor.LoopControl.looping_continues"), //$NON-NLS-1$
      Resources::get_string("Editor.LoopControl.looping_ends"), //$NON-NLS-1$
      Resources::get_string("Editor.DoAction.perform_before"), //$NON-NLS-1$
      Resources::get_string("Editor.DoAction.perform_after"), //$NON-NLS-1$
      Resources::get_string("Editor.LoopControl.loop_index"), //$NON-NLS-1$
      Resources::get_string("Editor.LoopControl.index_name"), //$NON-NLS-1$
      Resources::get_string("Editor.LoopControl.index_start"), //$NON-NLS-1$
      Resources::get_string("Editor.LoopControl.index_step") //$NON-NLS-1$
    );
  }
  ...
  public static class NamedHotkeyListConfigurer extends ListConfigurer {
    ...
    protected Configurer buildChildConfigurer() {
      return new NamedHotKeyConfigurer(null, Resources::get_string(Resources.HOTKEY_LABEL));
    }
  }
  ...
  protected void doActions() throws RecursionLimitException {
    ...
    if (LoopControl.LOOP_COUNTED.equals(loopType)) {
      loopCountLimit = loopCount.getTextAsInt(mod, Resources::get_string("Editor.LoopControl.loop_count"), this); //$NON-NLS-1$
    }
  ...
  public List<NamedKeyStroke> get_namedKeyStrokeList() {
    final List<NamedKeyStroke> l = new ArrayList<>(super.get_namedKeyStrokeList());
    l.addAll(hotkeys);
