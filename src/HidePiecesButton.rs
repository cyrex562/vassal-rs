...
public class HidePiecesButton extends JPanel implements MouseListener,
  ...
  public HidePiecesButton() {
    ...
    launch.setAttribute(TOOLTIP, Resources::get_string("Editor.HidePiecesButton.hide_all_pieces_on_this_map"));
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      ...
      Resources::get_string("Editor.HidePiecesButton.show_icon"), //$NON-NLS-1$
      Resources::get_string("Editor.HidePiecesButton.hide_icon"), //$NON-NLS-1$
    };
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.HidePiecesButton.component_type"); //$NON-NLS-1$
  }
