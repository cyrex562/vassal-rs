...
public class Immobilized extends Decorator implements EditablePiece {
  ...
  public String getDescription() {
    ...
    String options = "";
    if (canStack) {
      options += Resources::get_string("Editor.Immobilized.summary_does_stack");
    }
    ...
    if (neverSelect) {
      ...
      options += Resources::get_string("Editor.Immobilized.summary_never_select");
    }
    else if (altToSelect) {
      if (!options.isEmpty()) {
        options += ", ";
      }
      options += Resources::get_string("Editor.Immobilized.summary_alt_select");
    }
    else if (shiftToSelect) {
      if (!options.isEmpty()) {
        options += ", ";
      }
      options += Resources::get_string("Editor.Immobilized.summary_shift_select");
    }
    else if (ctrlToSelect) {
      if (!options.isEmpty()) {
        options += ", ";
      }
      options += Resources::get_string("Editor.Immobilized.summary_ctrl_select");
    }
    ...
    if (!neverSelect) {
      if (neverBandSelect) {
        ...
        options += Resources::get_string("Editor.Immobilized.summary_never_band_select");
      }
      else if (altToBandSelect) {
        if (!options.isEmpty()) {
          options += ", ";
        }
        options += Resources::get_string("Editor.Immobilized.summary_alt_band_select");
      }
      else if (altShiftToBandSelect) {
        if (!options.isEmpty()) {
          options += ", ";
        }
        options += Resources::get_string("Editor.Immobilized.summary_alt_shift_band_select");
      }
    }
    ...
    if (neverMove) {
      ...
      options += Resources::get_string("Editor.Immobilized.summary_never_move");
    }
    else if (moveIfSelected) {
      if (!options.isEmpty()) {
        options += ", ";
      }
      options += Resources::get_string("Editor.Immobilized.summary_move_if_selected");
    }
  ...
  public String getBaseDescription() {
    return Resources::get_string("Editor.Immobilized.trait_description");
  }
