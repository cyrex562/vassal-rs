...
public class SpecialDieFace extends AbstractConfigurable {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.SpecialDieFace.component_type"); //$NON-NLS-1$
  }

  @Override
  public String[] getAttributeDescriptions() {
    return new String[]{
        Resources::get_string("Editor.SpecialDieFace.text_value"), //$NON-NLS-1$
          Resources::get_string("Editor.SpecialDieFace.numeric_value"), //$NON-NLS-1$
          Resources::get_string("Editor.SpecialDieFace.icon") //$NON-NLS-1$
    };
  }
