...
public abstract class RegularGridNumbering extends AbstractConfigurable implements GridNumbering {
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      Resources::get_string("Editor.RegularGridNumbering.order"),
      Resources::get_string("Editor.RegularGridNumbering.separator"),
      Resources::get_string("Editor.RegularGridNumbering.horizontal_numbering"),
      Resources::get_string("Editor.RegularGridNumbering.leading_zeros_in_horizontal"),
      Resources::get_string("Editor.RegularGridNumbering.starting_number_in_horizontal"),
      Resources::get_string("Editor.RegularGridNumbering.horizontal_numbering_descending"),
      Resources::get_string("Editor.RegularGridNumbering.vertical_numbering"),
      Resources::get_string("Editor.RegularGridNumbering.leading_zeros_in_vertical"),
      Resources::get_string("Editor.RegularGridNumbering.starting_number_in_vertical"),
      Resources::get_string("Editor.RegularGridNumbering.vertical_numbering_descending"),
      Resources::get_string("Editor.RegularGridNumbering.location_format"),
      Resources::get_string("Editor.RegularGridNumbering.draw_numbering"),
      Resources::get_string("Editor.RegularGridNumbering.font_size"),
      Resources::get_string("Editor.color_label"),
      Resources::get_string("Editor.RegularGridNumbering.rotate_text_degrees"),
      Resources::get_string("Editor.RegularGridNumbering.text_x_offset"),
      Resources::get_string("Editor.RegularGridNumbering.text_y_offset")
    };
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.RegularGridNumbering.component_type");
  }
  ...
  protected String get_name(int row, int column) {
    final String rowName = get_name(row + vOff, vType, vLeading);
    final String colName = get_name(column + hOff, hType, hLeading);
    if (first == 'H') {
...
// FIXME: rename to BadCoordsException
  ...
  public String locationName(Point pt) {
    ...
    format.setProperty(GRID_LOCATION, get_name(row, col));
    format.setProperty(ROW, get_name(row + vOff, vType, vLeading));
    format.setProperty(COLUMN, get_name(col + hOff, hType, hLeading));
  ...
  protected String get_name(int rowOrColumn, char type, int leading) {
