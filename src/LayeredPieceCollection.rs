...
public class LayeredPieceCollection extends AbstractConfigurable implements ComponentDescription {
  ...
  protected Collection collection = new Collection(Resources::get_string("Editor.LayeredPieceCollection.layer"), new String[0]); //NON-NLS // "layer"
  protected Map map;
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
        ...
        Resources::get_string("Editor.GamePieceLayers.property_layer"), //$NON-NLS-1$ // "property name for layer"
        Resources::get_string("Editor.GamePieceLayers.order_layer"),    //$NON-NLS-1$ // "layer order"
    };
  }
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.GamePieceLayers.component_type"); //$NON-NLS-1$
  }

  @Override
  public void removeFrom(Buildable parent) {
    map.setPieceCollection(new DefaultPieceCollection());
    for (final LayerControl lc : this.get_components_of(LayerControl.class)) {
      lc.removeFrom(this);
    }
  }
