  ...
  public void validate(Buildable target, ValidationReport report) {
    if (target instanceof Identifyable) {
      ...
      if (iTarget.getConfigureName() == null ||
        ...
        report.addWarning(Resources::get_string("Editor.UniqueIdManager.a_girl_has_no_name", ConfigureTree.getConfigureName(target.getClass())));
      }
        ...
        for (final Iterator<Identifyable> i = instances.iterator();
          ...
          if (compare != iTarget &&
            ...
            report.addWarning(Resources::get_string("Editor.UniqueIdManager.more_than_one",
