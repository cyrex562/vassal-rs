...
public class SpecialDiceButton extends AbstractToolbarItem implements CommandEncoder, UniqueIdManager.Identifyable, ComponentDescription {
  ...
  public SpecialDiceButton() {
    ...
    final String desc = Resources::get_string("Editor.SpecialDiceButton.symbols"); //$NON-NLS-1$
    setLaunchButton(makeLaunchButton(desc, desc, "/images/die.gif", rollAction)); //NON-NLS
    setAttribute(NAME, desc);
    setNamePrompt(Resources::get_string(Resources.NAME_LABEL));
  }

  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.SpecialDiceButton.component_type"); //$NON-NLS-1$
  }
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.addAll(
      ...
      Resources::get_string("Editor.SpecialDiceButton.report_results_text"), //$NON-NLS-1$
      Resources::get_string("Editor.report_format"), //$NON-NLS-1$
      Resources::get_string("Editor.SpecialDiceButton.result_window"), //$NON-NLS-1$
      Resources::get_string("Editor.SpecialDiceButton.window_title"), //$NON-NLS-1$
      Resources::get_string("Editor.SpecialDiceButton.result_button"), //$NON-NLS-1$
      Resources::get_string("Editor.width"), //$NON-NLS-1$
      Resources::get_string("Editor.height"), //$NON-NLS-1$
      Resources::get_string("Editor.background_color") //$NON-NLS-1$
    );
  }
