...
public class PieceWindow extends Widget implements UniqueIdManager.Identifyable {
  ...
  public PieceWindow() {
    ...
    launch = new LaunchButton(
      Resources::get_string("Editor.PieceWindow.pieces"),
      TOOLTIP,
      BUTTON_TEXT,
      HOTKEY,
      ICON,
    ...
    launch.setToolTipText(
      Resources::get_string("Editor.PieceWindow.show_hide_pieces_window",
      Resources::get_string("Editor.PieceWindow.pieces"))
    );
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.PieceWindow.component_type"); //$NON-NLS-1$
  }
  ...
  public String[] getAttributeDescriptions() {
    return new String[]{
      ...
      Resources::get_string("Editor.PieceWindow.hidden"), //$NON-NLS-1$
      ...
      Resources::get_string("Editor.PieceWindow.show_hide"), //$NON-NLS-1$
      Resources::get_string("Editor.PieceWindow.scale"),
      Resources::get_string("Editor.PieceWindow.default_docked_width")
    };
  }
  ...
  public void setAttribute(String name, Object value) {
    if (DEPRECATED_NAME.equals(name)) {
      ...
      setConfigureName(s);
      if (tooltip.isEmpty()) {
        launch.setToolTipText(Resources::get_string("Editor.PieceWindow.show_hide_pieces_window", s));
      }
    }
