...
public class OfficialNodeClientFactory extends NodeClientFactory {
  ...
  private static final String UNNAMED_MODULE = Resources::get_string("Chat.unknown_module");  //$NON-NLS-1$
  private static final String UNKNOWN_USER = Resources::get_string("Chat.unknown_user");  //$NON-NLS-1$
