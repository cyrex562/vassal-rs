...
public class MoveCameraButton extends AbstractToolbarItem {
  ...
  public MoveCameraButton() {
    ...
    setLaunchButton(makeLaunchButton(
      Resources::get_string("Editor.MoveCameraButton.move_camera_tooltip"),
      Resources::get_string("Editor.MoveCameraButton.move_camera"),
  ...
  private void offsetDest(Point dest) {
    ...
    try {
      ...
      ErrorDialog.dataWarning(new BadDataReport(this, Resources::get_string("Error.non_number_error"), xOffset.debugInfo(dxString, "X Offset"))); //NON-NLS
      return;
    }
    ...
    try {
      ...
      ErrorDialog.dataWarning(new BadDataReport(this, Resources::get_string("Error.non_number_error"), yOffset.debugInfo(dyString, "Y Offset"))); //NON-NLS
      return;
    }
    ...
    if (dest != null) {
      ...
      if (!zoomString.strip().isEmpty()) {
        ...
        try {
          ...
          ErrorDialog.dataWarning(new BadDataReport(this, Resources::get_string("Error.non_number_error"), Resources::get_string("Editor.MoveCameraButton.zoom") + ": " + zoomString, e));
          toZoom = 0;
        }
        if (toZoom > 0) {
  ...
  public static String getConfigureTypeName() {
    return Resources::get_string("Editor.MoveCameraButton.component_type");
  }
  ...
  public String[] getAttributeDescriptions() {
    return ArrayUtils.addAll(
      ...
      Resources::get_string("Editor.MoveCameraButton.move_camera_mode"),
      Resources::get_string("Editor.MoveCameraButton.board"),
      Resources::get_string("Editor.MoveCameraButton.zone"),
      Resources::get_string("Editor.MoveCameraButton.region"),
      Resources::get_string("Editor.MoveCameraButton.grid"),
      Resources::get_string("Editor.MoveCameraButton.x"),
      Resources::get_string("Editor.MoveCameraButton.y"),
      Resources::get_string("Editor.MoveCameraButton.x_offset"),
      Resources::get_string("Editor.MoveCameraButton.y_offset"),
      Resources::get_string("Editor.MoveCameraButton.property_filter"),
      Resources::get_string("Editor.MoveCameraButton.zoom")
      );
  }
